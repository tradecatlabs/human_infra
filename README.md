...
| 认知、心理与行动能力 | 判断、学习、心理稳定、压力恢复和高压表现是否可持续 | 认知增强、心理健康与情绪稳定、睡眠与恢复、疼痛与痛苦控制、AI 协作、外部记忆 |
| 工具、测量与反馈 | 工具、AI、数据和反馈系统是否放大主体能力而不侵蚀主体权利 | 人机协作、AI 代理安全、测量反馈、生命路径预测、个人健康记录、可穿戴、患者数据可携带 |
| 环境、资源与风险底座 | 生活环境和资源是否让人有继续行动的现实条件 | 星球健康与环境、资源与社会基础设施、供应链连续性、风险工程、合成生物学与生物安全、空间与极端栖居、辅助技术、物质暴露控制、住房、食物、水、能源、交通、气候韧性 |
| 制度与协作网络 | 身份、权利、服务和社会协作是否把人接入可恢复的公共系统 | 治理与主体权利、数字身份安全、社会连接、健康素养导航、法律身份、司法可及、公共福利、社区资源导航、劳动权利、迁移与人道服务 |
