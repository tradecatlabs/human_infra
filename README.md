...
过去这些线路常被分开讨论：长寿、自我量化、可穿戴健康、睡眠、运动、营养等公共健康基线、慢性压力与恢复、社会决定因素、康复与可访问性、职业健康、老年照护、极端环境人因、军队表现优化、神经科技、AI 工具和系统安全。
...
| 查看真实应用与文献 | [docs/reference/applications-and-literature.md](docs/reference/applications-and-literature.md) | Bryan Johnson、NIA ITP、All of Us、ClinicalTrials.gov、FDA RWE、PROMIS、GBD、Allostatic Load、WHO SDOH、WHO Rehab、WCAG、Section 508、WHO-CHOICE、NICE HTA、HIPAA、NIST Privacy、GA4GH、FDA BCI、WHO Patient Safety、NASA、BRAIN 等资料索引 |
