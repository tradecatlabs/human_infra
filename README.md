...
| 生物与健康连续性 | 身体、寿命、疾病、康复、照护和药物是否支撑长期行动 | 长寿证据、细胞重编程、再生医学、癌症控制、免疫维护、生物停滞、医疗可及、康复、长期照护 |
| 神经与身份连续性 | 大脑、记忆、意识、人格和行动能力是否保持为同一主体 | 神经连续性、记忆编辑、去具身中枢生命系统、脑保存、认知退行防控 |
| 认知与行动能力 | 判断、学习、心理稳定、压力恢复和高压表现是否可持续 | 认知增强、AI 协作、外部记忆、学习科学、职业健康、极端环境人因 |
| 工具、测量与反馈 | 工具、AI、数据和反馈系统是否放大主体能力而不侵蚀主体权利 | 人机协作、测量反馈、生命路径预测、个人健康记录、可穿戴、患者数据可携带 |
| 环境、资源与风险底座 | 生活环境和资源是否让人有继续行动的现实条件 | 资源与社会基础设施、风险工程、住房、食物、水、能源、交通、金融接入、保险、气候韧性 |
| 制度与协作网络 | 身份、权利、服务和社会协作是否把人接入可恢复的公共系统 | 治理与主体权利、法律身份、司法可及、公共福利、社区资源导航、劳动权利、迁移与人道服务 |
