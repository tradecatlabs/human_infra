...
| 环境、资源与风险底座 | 生活环境和资源是否让人有继续行动的现实条件 | 星球健康与环境、资源与社会基础设施、财务韧性与资源可及、供应链连续性、风险工程、合成生物学与生物安全、空间与极端栖居、辅助技术、物质暴露控制、住房、食物、水、能源、交通、气候韧性 |
| 制度与协作网络 | 身份、权利、服务、信息环境和社会协作是否把人接入可恢复的公共系统 | 治理与主体权利、数字身份安全、社会连接、职业与工作设计、时间分配与有效时间、信息完整性与信任、健康素养导航、法律身份、司法可及、公共福利、社区资源导航、劳动权利、迁移与人道服务 |
