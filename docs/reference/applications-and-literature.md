...
| 长寿干预执行与证据治理 | NIA ITP；NIH ODS；FDA Dietary Supplements；HHS/WHO physical activity guidelines；NIA CALERIE；sauna / heat therapy / cold exposure systematic reviews | 把抗衰药物、补剂、抗阻训练、心肺适能、热量限制/禁食和冷热应激从“健康叙事”拆成变量、终点、证据等级、安全门槛和禁止用途 | `domains/geroprotective-drug-repurposing-trial-governance-continuity/`、`domains/dietary-supplement-nutraceutical-evidence-safety-continuity/`、`domains/resistance-training-muscle-strength-sarcopenia-continuity/`、`domains/cardiorespiratory-fitness-vo2max-aerobic-capacity-continuity/`、`domains/caloric-restriction-fasting-energy-balance-governance-continuity/`、`domains/thermal-stress-sauna-cold-exposure-hormesis-governance-continuity/` |
| 生物医学平台、活体神经基质、年龄指标与器官替换 | FDA gene/cell therapy；FDA genome editing guidance；NIA aging biology；Horvath clock；GrimAge；DunedinPACE；HuBMAP；Bridge2AI；NCI CAR-T；ISSCR；NCATS Tissue Chip；Cortical Labs / DishBrain；Organoid Intelligence；FDA Xenotransplantation；OPTN | 把遗传递送安全、生物年龄验证、多组学基线、工程细胞、人体相关模型、合成生物智能/类器官计算和器官替换纳入 Human Infra，而不是把它们混成“神奇延寿技术”或“生物意识证明” | `domains/gene-therapy-genome-editing-delivery-safety/`、`domains/biological-age-clocks-biomarker-validation/`、`domains/multiomics-personal-baseline-systems-biology/`、`domains/engineered-cell-therapy-regenerative-platforms/`、`domains/organoids-organ-on-chip-disease-models/`、`domains/synthetic-biological-intelligence-organoid-computing-continuity/`、`domains/xenotransplantation-bioengineered-organ-replacement/` |
| 细胞内质量控制与分子信息维护 | PubMed / PMC lysosome and lipofuscin reviews；ubiquitin-proteasome aging review；protein synthesis / quality-control review；translational control and fidelity literature；RNA imbalance / alternative splicing / mRNA quality-control reviews；nuclear gateway / karyopherin aging literature；ferroptosis and lipid-peroxidation reviews | 把细胞内回收、选择性蛋白降解、新蛋白生成、RNA 执行、核内外交换和膜脂死亡风险拆成可建模变量，而不是把它们混成单一“抗衰通路” | `domains/lysosomal-flux-lipofuscin-clearance-continuity/`、`domains/ubiquitin-proteasome-protein-turnover-continuity/`、`domains/ribosome-translation-fidelity-proteome-integrity-continuity/`、`domains/rna-splicing-epitranscriptomic-maintenance-continuity/`、`domains/nuclear-gateway-nucleocytoplasmic-transport-continuity/`、`domains/ferroptosis-lipid-peroxidation-membrane-resilience-continuity/` |
| 细胞器稳态、空间组织与应激响应 | PubMed ER/UPR；Golgi stress；peroxisomal stress；MAMs/contact sites；biomolecular condensates；mechanobiology of aging | 把 ER 折叠压力、Golgi 分泌供应链、过氧化物酶体脂质氧化还原、细胞器接触位点、无膜空间组织和细胞力学反馈拆成研究域，而不是混进线粒体、蛋白稳态或 ECM | `domains/endoplasmic-reticulum-stress-upr-proteostasis-continuity/`、`domains/golgi-secretory-trafficking-organelle-homeostasis-continuity/`、`domains/peroxisome-redox-lipid-metabolism-homeostasis-continuity/`、`domains/organelle-contact-sites-intercompartmental-communication-continuity/`、`domains/biomolecular-condensates-phase-separation-stress-adaptation-continuity/`、`domains/cytoskeleton-mechanotransduction-cellular-mechanics-continuity/` |
| 定量方法学与模型治理 | Hernan / Robins causal inference；target trial emulation；Kaplan-Meier；Cox proportional hazards；human digital twin；RE-AIM；COM-B；TRIPOD；PROBAST；STROBE；RECORD | 把“技术是否有用”转成可审查的因果问题、风险函数、生命路径仿真、实施门槛、校准不确定性和数据入口审查 | `domains/causal-inference-target-trial-emulation/`、`domains/survival-analysis-healthspan-risk-modeling/`、`domains/human-digital-twin-life-course-simulation/`、`domains/implementation-science-adherence-behavior-change/`、`domains/uncertainty-quantification-model-calibration/`、`domains/data-quality-missingness-representativeness/` |
| 知识治理、技术预见与扩散 | NIST Privacy Framework；FAIR Principles；OBO Foundry；W3C RDF/OWL；Model Cards；Datasheets；NIST AI RMF；OECD foresight；WHO HTA；NIH OPA；WIPO Technology Transfer；Bayh-Dole | 把研究系统从资料堆升级为可隐私保护、可语义组织、可模型审计、可未来扫描、可组合排序和可技术扩散的基础设施 | `domains/privacy-preserving-computation-federated-learning/`、`domains/knowledge-graph-ontology-semantic-interoperability/`、`domains/model-cards-ai-audit-documentation/`、`domains/technology-foresight-horizon-scanning/`、`domains/research-portfolio-prioritization-funding-governance/`、`domains/intellectual-property-technology-transfer-access/` |
| 科研证据基础设施 | ICMJE Recommendations；COPE Core Practices；OHRP Common Rule；PCORI Engagement Rubric；ISBER Best Practices；NCI Biospecimen Best Practices；UK Biobank；Framingham；AHRQ registries guide；FDA RWE；NIST calibration | 把研究结论进入模型之前的传播状态、同意合法性、样本质量、长期随访、真实世界登记和仪器校准变成可审查前置条件 | `domains/trustworthy-scientific-communication-peer-review/`、`domains/research-participant-consent-community-engagement/`、`domains/biobanking-biospecimen-quality-chain-of-custody/`、`domains/longitudinal-cohort-retention-followup-infrastructure/`、`domains/registries-real-world-data-governance/`、`domains/scientific-instrumentation-sensor-calibration-maintenance/` |
| 科研身份、持久标识与可复现研究基础设施 | ORCID；ROR；DOI Foundation；Crossref；DataCite；NIH DMS；GO FAIR；FORCE11 Software Citation；Software Heritage；CITATION.cff；OSF Registries；protocols.io；CRediT；ICMJE disclosure；LOCKSS/CLOCKSS；Zenodo | 把研究者身份、机构、引用对象、数据仓库、研究软件、预注册、协议版本、贡献者角色、资金披露和研究产物保存变成模型证据进入前的可审查条件 | `domains/scholarly-identity-orcid-affiliation-continuity/`、`domains/persistent-identifier-doi-citation-metadata-continuity/`、`domains/research-data-repository-fair-sharing-continuity/`、`domains/research-software-capsule-reproducibility-continuity/`、`domains/preregistration-registered-report-study-plan-continuity/`、`domains/lab-notebook-protocol-versioning-continuity/`、`domains/contributor-role-authorship-attribution-continuity/`、`domains/conflict-of-interest-funding-disclosure-continuity/`、`domains/research-artifact-archive-retention-preservation-continuity/` |
| 证据综合与指南转化 | PRISMA；PROSPERO；Cochrane Handbook；RoB 2；ROBINS-I；QUADAS-2；PROBAST；GRADE；AGREE II；WHO guideline handbook；NICE HTA；Cochrane Rapid Reviews；Retraction Watch | 把原始研究进入模型之前的检索、偏倚、效应合成、报告偏倚、证据确定性、证据到决策、指南适配、证据更新和快速临时判断变成可审查条件 | `domains/systematic-review-protocol-search-screening-continuity/`、`domains/risk-of-bias-critical-appraisal-continuity/`、`domains/meta-analysis-effect-size-heterogeneity-continuity/`、`domains/publication-reporting-bias-detection-continuity/`、`domains/evidence-certainty-grade-summary-findings-continuity/`、`domains/evidence-to-decision-guideline-panel-continuity/`、`domains/guideline-appraisal-adaptation-localization-continuity/`、`domains/living-evidence-surveillance-update-continuity/`、`domains/rapid-review-emergency-evidence-triage-continuity/` |
...
| 未来技术连续性 | NCI nanotechnology；FDA nanotechnology；FDA AI/ML drug development；Nature epigenetic editing；NIH BRAIN Initiative；Human Connectome Project；NIST PQC；NASA formal methods；NIST SSDF；Library of Congress Digital Preservation；NDSA Levels；DPC Handbook | 把未来技术从“可能出现”拆成可生成、可递送、可调控、可保存、可长期安全、可形式化验证和可长期读取的连续性条件 | `domains/nanomedicine-targeted-delivery-molecular-repair/`、`domains/ai-drug-discovery-protein-design/`、`domains/epigenetic-editing-gene-regulation-therapeutics/`、`domains/brain-preservation-connectomics-emulation/`、`domains/post-quantum-cryptography-long-term-data-security/`、`domains/safety-critical-software-formal-methods/`、`domains/long-term-digital-preservation-format-migration/` |
| 急性神经连续性与意识韧性 | CDC/WHO/NINDS stroke；CDC/NINDS TBI；SCCM PADIS；NICE delirium；NINDS/AAN disorders of consciousness；WHO/CDC/NINDS epilepsy；NINDS/MedlinePlus/NHLBI autonomic disorders；WHO/NINDS headache disorders | 把脑灌注、神经创伤、谵妄、意识障碍、发作网络、自主调节和头痛失能拆成可审查的主体连续性断点，而不是混入一般神经连续性叙事 | `domains/cerebrovascular-stroke-brain-perfusion-resilience/`、`domains/traumatic-brain-injury-neurotrauma-recovery/`、`domains/delirium-acute-cognitive-failure-prevention/`、`domains/disorders-of-consciousness-coma-recovery/`、`domains/epilepsy-seizure-network-stability/`、`domains/autonomic-nervous-system-homeostasis/`、`domains/migraine-headache-effective-time-burden/` |
| 感官、沟通与具身反馈连续性 | WHO/CDC/NEI vision；WHO/NIDCD hearing；NIDCD balance；CDC STEADI；NIDCD aphasia；NIDCD dysphagia；NIDCD smell/taste；NINDS/NIDDK neuropathy | 把视觉、听觉、平衡、语言、吞咽、嗅味觉和周围神经拆成输入、表达、定向、营养进入、危险识别和身体边界反馈条件 | `domains/vision-eye-health-continuity/`、`domains/hearing-auditory-communication-continuity/`、`domains/vestibular-balance-spatial-orientation/`、`domains/speech-language-communication-continuity/`、`domains/swallowing-dysphagia-aspiration-nutrition/`、`domains/smell-taste-chemosensory-continuity/`、`domains/peripheral-neuropathy-somatosensory-continuity/` |
| 视觉失效、眼病功能与急性眼科连续性 | NEI cataract；NEI glaucoma；NEI diabetic retinopathy；NEI AMD；NEI refractive errors；NEI low vision；NEI dry eye；NEI eye injuries；NEI amblyopia；NEI retinal detachment；CDC Vision Health | 把视觉总域拆成可恢复视觉、不可逆视野保护、代谢视网膜筛治、中央视觉、基础屈光矫正、低视力补偿、眼表舒适、急性眼伤、儿童视觉发育和时间敏感型视网膜急转 | `domains/cataract-vision-restoration-continuity/`、`domains/glaucoma-visual-field-protection-continuity/`、`domains/diabetic-retinopathy-screening-treatment-continuity/`、`domains/age-related-macular-degeneration-central-vision-continuity/`、`domains/refractive-error-glasses-contact-lens-continuity/`、`domains/low-vision-rehabilitation-assistive-technology-continuity/`、`domains/dry-eye-ocular-surface-comfort-continuity/`、`domains/eye-injury-urgent-vision-protection-continuity/`、`domains/pediatric-vision-screening-amblyopia-continuity/`、`domains/retinal-detachment-urgent-referral-continuity/` |
| 听觉失效、助听支持与沟通访问连续性 | NIDCD age-related hearing loss / hearing aids / tinnitus / ear infections / sudden deafness / cochlear implants / newborn hearing screening / auditory processing；CDC/NIOSH noise；ADA effective communication；FCC TRS | 把听觉总域拆成年龄相关听损、噪声预防、耳鸣负担、儿童中耳炎、突发听损、人工耳蜗、新生儿听筛、听觉处理、辅助设备和字幕/中继访问 | `domains/age-related-hearing-loss-hearing-aid-continuity/`、`domains/noise-induced-hearing-loss-prevention-continuity/`、`domains/tinnitus-sound-tolerance-sleep-continuity/`、`domains/otitis-media-child-hearing-development-continuity/`、`domains/sudden-hearing-loss-urgent-referral-continuity/`、`domains/cochlear-implant-communication-continuity/`、`domains/newborn-hearing-screening-language-development-continuity/`、`domains/auditory-processing-listening-effort-continuity/`、`domains/hearing-assistive-devices-alerting-access-continuity/`、`domains/captions-relay-service-communication-access-continuity/` |
| 前庭失效、平衡补偿与空间行动连续性 | NIDCD balance/Meniere；CDC STEADI；APTA/ANPT vestibular rehabilitation；CDC Yellow Book motion sickness；NASA HRP；CDC/NIOSH ototoxic chemicals | 把前庭总域拆成 BPPV 位置性眩晕、梅尼埃发作、急性前庭炎/迷路炎、PPPD、前庭性偏头痛、双侧前庭低下、前庭康复、步态平衡筛查、运动病和前庭耳毒性 | `domains/bppv-positional-vertigo-continuity/`、`domains/menieres-disease-episodic-vertigo-continuity/`、`domains/vestibular-neuritis-labyrinthitis-acute-vertigo-continuity/`、`domains/persistent-postural-perceptual-dizziness-continuity/`、`domains/vestibular-migraine-dizziness-sensory-load-continuity/`、`domains/bilateral-vestibular-hypofunction-gaze-gait-stability-continuity/`、`domains/vestibular-rehabilitation-balance-compensation-continuity/`、`domains/gait-balance-assessment-fall-screening-continuity/`、`domains/motion-sickness-transport-virtual-environment-tolerance-continuity/`、`domains/vestibular-ototoxicity-medication-chemical-risk-continuity/` |
| 言语语言失效、表达冗余与沟通参与连续性 | NIDCD aphasia / voice / stuttering / DLD / assistive devices；ASHA aphasia / dysarthria / apraxia / voice / fluency / child language / speech sound / AAC / social communication / cognitive-communication | 把言语语言总域拆成失语、构音障碍、言语失用、嗓音障碍、口吃、发展性语言障碍、语音障碍、AAC、社会语用沟通和认知沟通 | `domains/aphasia-language-access-recovery-continuity/`、`domains/dysarthria-speech-intelligibility-continuity/`、`domains/apraxia-of-speech-motor-planning-continuity/`、`domains/voice-disorders-phonation-communication-continuity/`、`domains/stuttering-fluency-participation-continuity/`、`domains/developmental-language-disorder-child-communication-continuity/`、`domains/speech-sound-disorder-articulation-phonology-continuity/`、`domains/augmentative-alternative-communication-aac-continuity/`、`domains/social-communication-pragmatic-language-continuity/`、`domains/cognitive-communication-disorder-executive-language-continuity/` |
| 吞咽失效、误吸气道、营养入口与用餐尊严连续性 | NIDCD dysphagia；ASHA adult dysphagia / pediatric feeding and swallowing；IDDSI；AHA/ASA stroke dysphagia screening；ASPEN/ESPEN enteral nutrition；CMS paid feeding assistants；MedlinePlus swallowing/choking | 把吞咽总域拆成口咽、食管、误吸肺炎、窒息、质地调整饮食/稠液、管饲、儿童摄食、卒中后吞咽、神经退行性吞咽和进食协助 | `domains/oropharyngeal-dysphagia-swallow-safety-continuity/`、`domains/esophageal-dysphagia-motility-obstruction-continuity/`、`domains/aspiration-pneumonia-airway-protection-continuity/`、`domains/choking-foreign-body-airway-risk-continuity/`、`domains/texture-modified-diet-thickened-liquid-continuity/`、`domains/enteral-feeding-tube-nutrition-continuity/`、`domains/pediatric-feeding-swallowing-development-continuity/`、`domains/post-stroke-dysphagia-screening-recovery-continuity/`、`domains/neurodegenerative-dysphagia-nutrition-continuity/`、`domains/feeding-assistance-mealtime-dignity-continuity/` |
| 泌尿、肾脏替代与排泄出口连续性 | NIDDK UTI / urinary retention / kidney stones / BPH / urinary diversion / hemodialysis / peritoneal dialysis / kidney transplant；CDC CAUTI；NKF dialysis access / home dialysis / kidney transplant；MedlinePlus urostomy | 把泌尿生殖和肾脏清除总域拆成尿路感染、CAUTI、尿潴留、夜尿、结石、BPH、尿流改道、透析通路、家庭透析和肾移植这些排泄出口与替代执行层 | `domains/urinary-tract-infection-pyelonephritis-urosepsis-continuity/`、`domains/catheter-associated-uti-device-infection-continuity/`、`domains/urinary-retention-bladder-emptying-continuity/`、`domains/overactive-bladder-nocturia-sleep-continuity/`、`domains/kidney-stone-obstruction-renal-colic-continuity/`、`domains/benign-prostatic-hyperplasia-luts-continuity/`、`domains/urinary-diversion-urostomy-supplies-continuity/`、`domains/dialysis-access-vascular-peritoneal-continuity/`、`domains/home-dialysis-supply-self-management-continuity/`、`domains/kidney-transplant-immunosuppression-graft-continuity/` |
| 皮肤屏障、伤口、压力损伤与皮肤病执行连续性 | AHRQ pressure injury prevention toolkit；NPIAP pressure injury staging；CDC/NHSN SSI；NIDDK diabetic foot；CDC diabetes and your feet；MedlinePlus pressure injuries / wounds / cellulitis / burns；NIAMS atopic dermatitis / psoriasis；FDA wound dressings | 把皮肤屏障总域拆成压力损伤、慢性伤口、伤口感染、糖尿病足、烧伤后创面、手术切口/SSI、潮湿相关皮炎、湿疹、银屑病和皮肤护理用品这些材料、照护、感染和功能执行层 | `domains/pressure-injury-prevention-repositioning-support-surface-continuity/`、`domains/chronic-wound-venous-diabetic-pressure-ulcer-continuity/`、`domains/wound-infection-cellulitis-sepsis-continuity/`、`domains/diabetic-foot-ulcer-amputation-prevention-continuity/`、`domains/burn-wound-aftercare-scar-function-continuity/`、`domains/surgical-wound-dehiscence-ssi-continuity/`、`domains/incontinence-associated-dermatitis-moisture-skin-continuity/`、`domains/eczema-atopic-dermatitis-itch-sleep-continuity/`、`domains/psoriasis-inflammatory-skin-systemic-burden-continuity/`、`domains/skin-care-supplies-dressings-barrier-products-continuity/` |
| 行星、地球物理与极端热风险连续性 | NOAA/NASA space weather；NASA CNEOS/IAWN planetary defense；USGS volcanic hazards/ash；USGS/ShakeAlert/FEMA earthquakes；NOAA Tsunami/Ready.gov tsunamis；CDC/NOAA/OSHA heat | 把太阳活动、近地天体、火山灰、地震、海啸和极端高温拆成可观测、可预警、可缓解和可恢复的外部风险条件 | `domains/space-weather-geomagnetic-storm-resilience/`、`domains/planetary-defense-near-earth-object-risk/`、`domains/volcanic-ashfall-geohazard-continuity/`、`domains/earthquake-seismic-risk-built-environment-continuity/`、`domains/tsunami-warning-coastal-evacuation-continuity/`、`domains/extreme-heat-cooling-public-health-continuity/` |
| 强天气与自然 hazard 执行连续性 | NWS Weather Safety；Ready.gov alerts/hazards；NHC hurricane；AirNow/CDC/EPA wildfire smoke；USGS landslide hazards；Drought.gov；NOAA high tide flooding | 把官方预警、风险沟通、撤离避难、寒冷/水限制、空气暴露、户外安全和沿海淹没拆成可审查的主体保护行动链 | `domains/severe-weather-watch-warning-risk-communication-continuity/`、`domains/river-flash-flood-warning-evacuation-continuity/`、`domains/hurricane-storm-surge-evacuation-shelter-continuity/`、`domains/tornado-warning-safe-room-shelter-continuity/`、`domains/winter-storm-cold-exposure-power-continuity/`、`domains/drought-water-restriction-household-health-continuity/`、`domains/landslide-mudslide-debris-flow-warning-continuity/`、`domains/wildfire-smoke-clean-air-respiratory-continuity/`、`domains/thunderstorm-lightning-outdoor-safety-continuity/`、`domains/coastal-flooding-erosion-inundation-continuity/` |
| 慢性环境暴露与日常损耗条件 | WHO/NIOSH/OSHA noise；NIH circadian rhythms / CDC NIOSH work schedules；CDC/EPA/ATSDR/NIEHS lead and heavy metals；EPA radon/asbestos；CDC/EPA/WHO mold and dampness；CDC/WHO/EPA vector-borne disease | 把噪声、光照节律、重金属、氡石棉、霉菌潮湿和病媒传播拆成可观测、可治理、可降低慢性恢复成本的日常环境条件 | `domains/noise-exposure-acoustic-environment-continuity/`、`domains/light-exposure-circadian-environment-continuity/`、`domains/lead-heavy-metal-exposure-control/`、`domains/radon-asbestos-indoor-hazard-continuity/`、`domains/mold-dampness-indoor-biological-exposure/`、`domains/vector-borne-disease-environmental-control/` |
| 病媒、动物接触、虫害与农药暴露执行连续性 | CDC mosquitoes / ticks / rabies / healthy pets / hantavirus / plague / bed bugs / lice / scabies；EPA bed bugs / safe pest control / pesticide labels；NPIC；Poison Help；AVMA dog bite prevention | 把病媒总论和家庭 pest control 拆成蚊、蜱、狂犬病暴露、犬咬伤、鼠害、床虱、毒咬蜇伤、爬宠家禽沙门氏菌、虱疥和农药标签中毒连接这些执行薄片 | `domains/mosquito-bite-arbovirus-prevention-continuity/`、`domains/tick-bite-lyme-rickettsial-prevention-continuity/`、`domains/rabies-exposure-bite-pep-continuity/`、`domains/dog-bite-community-injury-prevention-continuity/`、`domains/rodent-infestation-hantavirus-plague-continuity/`、`domains/bed-bug-infestation-sleep-housing-continuity/`、`domains/venomous-bites-stings-envenomation-continuity/`、`domains/reptile-amphibian-backyard-poultry-salmonella-continuity/`、`domains/lice-scabies-school-shelter-infestation-continuity/`、`domains/pesticide-label-exposure-poison-control-continuity/` |
| 植物、藻类、真菌与户外生物暴露执行连续性 | CDC asthma / harmful algal blooms / healthy swimming；CDC/NIOSH poisonous plants / outdoor workers；EPA asthma / HABs；NOAA HABs；FDA Bad Bug Book / shellfish sanitation；USDA invasive species / mycotoxins；OSHA landscaping；Poison Help | 把自然环境和户外维护中的植物、藻类、真菌、水域病原与食品毒素拆成花粉过敏、漆酚植物、有害藻华、野生蘑菇、有毒植物、入侵物种、霉菌毒素、休闲水病原、贝类毒素和园林园艺工伤这些执行薄片 | `domains/pollen-allergen-asthma-outdoor-activity-continuity/`、`domains/poison-ivy-oak-sumac-urushiol-exposure-continuity/`、`domains/harmful-algal-bloom-cyanotoxin-water-recreation-continuity/`、`domains/toxic-mushroom-foraging-poisoning-continuity/`、`domains/poisonous-plant-childcare-household-exposure-continuity/`、`domains/invasive-species-human-health-access-continuity/`、`domains/mycotoxin-food-crop-storage-safety-continuity/`、`domains/recreational-water-illness-beach-lake-access-continuity/`、`domains/shellfish-biotoxin-harmful-algal-bloom-food-continuity/`、`domains/landscaping-horticulture-worker-equipment-injury-continuity/` |
| 决策权、代理权与受托连续性 | NIA advance care planning / getting affairs in order；ACL supported decision-making；HHS HIPAA personal representative；CFPB Managing Someone Else's Money；SSA representative payee / advance designation；VA fiduciary | 把失能或不能表达时的医疗偏好、决策支持、资料访问、财务代办、公共收入和事务继承拆成可授权、可监督、可防滥用的连续性条件 | `domains/advance-care-planning-medical-decision-continuity/`、`domains/supported-decision-making-guardianship-rights/`、`domains/healthcare-personal-representative-hipaa-access-continuity/`、`domains/financial-fiduciary-power-of-attorney-continuity/`、`domains/representative-payee-benefits-management-continuity/`、`domains/trust-estate-affairs-succession-continuity/` |
| 算法化准入、筛查与资格连续性 | CFPB consumer reporting / credit reports；FTC tenant screening and background checks；EEOC AI and algorithmic fairness；NAIC insurance AI governance；Benefits.gov / CMS eligibility | 把信用报告、租房筛查、背景记录、算法招聘、保险评分和福利资格判定拆成进入关键资源系统之前的可审查准入层 | `domains/credit-consumer-reporting-access-continuity/`、`domains/tenant-screening-rental-access-continuity/`、`domains/background-check-record-screening-continuity/`、`domains/employment-algorithmic-hiring-screening-continuity/`、`domains/insurance-underwriting-algorithmic-risk-scoring-continuity/`、`domains/public-benefits-eligibility-automated-decision-continuity/` |
| 资格证明、证照与能力可携带连续性 | U.S. Department of Education FERPA；DOL CareerOneStop License Finder；BLS occupational licensing/certification；O*NET；Credential Engine / CTDL；W3C Verifiable Credentials；NIST Digital Identity Guidelines；Apprenticeship.gov | 把教育记录、职业执照、技能凭证、继续教育、学徒制和可验证凭证钱包拆成主体能否持续证明学习、能力、授权和合规状态的基础设施 | `domains/education-record-transcript-verification-continuity/`、`domains/professional-licensure-certification-continuity/`、`domains/skills-competency-credentialing-continuity/`、`domains/continuing-education-recertification-continuity/`、`domains/apprenticeship-work-based-learning-continuity/`、`domains/verifiable-credential-wallet-interoperability/` |
| 收入、税务、社保、退休、失业与工伤权益记录连续性 | DOL WHD；IRS Get Transcript；SSA Social Security Statement；DOL EBSA；PBGC；DOL unemployment insurance / ETA；DOL UI modernization；DOL OWCP；OSHA recordkeeping | 把工资雇佣记录、税务记录、社会保险收入记录、退休账户、失业保险工资记录、UI claim 执行和工伤记录拆成主体过去劳动能否转化为未来权益的基础设施 | `domains/income-payroll-employment-record-continuity/`、`domains/tax-administration-filing-record-continuity/`、`domains/social-security-earnings-benefit-record-continuity/`、`domains/retirement-pension-savings-plan-continuity/`、`domains/unemployment-insurance-wage-record-continuity/`、`domains/unemployment-insurance-claim-appeal-identity-continuity/`、`domains/workers-compensation-occupational-injury-benefit-continuity/` |
| 工作场所急性安全执行连续性 | OSHA Fall Protection；OSHA Control of Hazardous Energy；OSHA Machine Guarding；OSHA Powered Industrial Trucks；OSHA Confined Spaces；OSHA Bloodborne Pathogens；CDC/NIOSH Bloodborne Infectious Diseases | 把工作场所伤害从泛泛职业暴露拆成高处坠落、危险能量、机器危险点、工业车辆、受限空间和锐器/血源性暴露这些可观察、可报告、可治理的执行条件 | `domains/workplace-fall-protection-height-safety-continuity/`、`domains/hazardous-energy-lockout-tagout-continuity/`、`domains/machine-guarding-amputation-prevention-continuity/`、`domains/powered-industrial-truck-forklift-safety-continuity/`、`domains/confined-space-entry-atmospheric-hazard-continuity/`、`domains/bloodborne-pathogens-sharps-injury-worker-continuity/` |
| 施工与工业现场特定致命机制执行连续性 | OSHA Trenching and Excavation；OSHA Crane Derrick and Hoist Safety；OSHA Electrical；OSHA Welding Cutting Brazing；OSHA Silica Crystalline；OSHA Demolition | 把施工与工业现场伤害从泛泛职业暴露拆成沟槽坍塌、悬吊载荷、电击闪爆、热作业烟尘火灾、硅尘和拆除坍塌这些可观察、可报告、可治理的执行条件 | `domains/trenching-excavation-cave-in-worker-continuity/`、`domains/crane-derrick-hoist-rigging-suspended-load-continuity/`、`domains/occupational-electrical-shock-arc-flash-continuity/`、`domains/welding-cutting-brazing-fume-fire-continuity/`、`domains/respirable-crystalline-silica-dust-worker-continuity/`、`domains/demolition-structural-collapse-debris-continuity/` |
| 工作中断、照护事件与工作收入连续性 | DOL FMLA；DOL paid leave / sick leave；EEOC PWFA；DOL PUMP at Work；EEOC ADA reasonable accommodation；DOL ODEP / JAN；SSA Disability / SSI / appeals / continuing disability reviews；ACL National Family Caregiver Support Program / Lifespan Respite | 把疾病、怀孕、育儿、残障、残障福利复审申诉、照护和复工事件拆成主体能否保留岗位、工资替代、合理便利、残障收入、照护支持和职业角色的基础设施 | `domains/family-medical-leave-job-protection-continuity/`、`domains/paid-sick-family-leave-wage-replacement-continuity/`、`domains/pregnancy-parental-work-continuity/`、`domains/workplace-accommodation-return-to-work-continuity/`、`domains/disability-income-work-capacity-benefit-continuity/`、`domains/ssi-ssdi-disability-review-appeal-continuity/`、`domains/family-caregiver-respite-work-continuity/` |
| 公共福利资格、续期、覆盖转换与申诉执行连续性 | USDA FNS SNAP eligibility / work requirements / E&T；CMS Medicaid/CHIP eligibility and renewals；Medicare.gov enrollment and coverage options；SSA Disability / SSI / appeals / CDR；ACF TANF；DOL UI claimant and modernization materials | 把公共福利从“有项目”拆成资格、续期、重新判定、身份核验、工作要求、制裁、申诉、覆盖转接和支付执行这些可失效环节 | `domains/snap-eligibility-recertification-abawd-continuity/`、`domains/medicaid-chip-renewal-redetermination-continuity/`、`domains/medicare-enrollment-coverage-transition-continuity/`、`domains/ssi-ssdi-disability-review-appeal-continuity/`、`domains/tanf-cash-assistance-work-support-continuity/`、`domains/unemployment-insurance-claim-appeal-identity-continuity/` |
| 长期照护执行连续性 | ACL National Family Caregiver Support Program；ACL Lifespan Respite；Eldercare Locator；Medicaid HCBS / LTSS；NIA caregiving and long-term care；CMS home health；AHRQ care coordination / RED toolkit | 把长期照护从“家庭照护者会处理”拆成成人日间服务、居家照护人员、喘息容量、照护者训练、照护者健康和家庭任务协调这些每日执行条件 | `domains/adult-day-services-supervision-transport-continuity/`、`domains/home-care-aide-personal-care-workforce-continuity/`、`domains/respite-care-provider-capacity-scheduling-continuity/`、`domains/caregiver-training-skills-safety-continuity/`、`domains/caregiver-health-burnout-screening-support-continuity/`、`domains/home-care-task-coordination-care-plan-continuity/` |
| 人口与地域可达性连续性 | IHS；VA health care and benefits；HRSA migrant health / health centers；DOL MSPA；CDC U.S.-Mexico Health；Medicaid.gov U.S. territories；HHS Section 1557；CDC LGBT Health；SAMHSA LGBTQI+ | 把“服务存在”拆成主权治理、军转民、季节性劳动迁移、岛屿/属地供应链、边境跨制度生活和身份承认/反歧视服务接口 | `domains/tribal-health-sovereignty-service-access-continuity/`、`domains/veterans-health-benefits-navigation-continuity/`、`domains/migrant-seasonal-farmworker-health-housing-continuity/`、`domains/territorial-island-health-infrastructure-access-continuity/`、`domains/border-community-cross-border-care-continuity/`、`domains/lgbtq-health-identity-affirming-service-continuity/` | [IHS](https://www.ihs.gov/), [VA health care](https://www.va.gov/health-care/), [VA benefits](https://www.va.gov/), [HRSA health centers](https://bphc.hrsa.gov/), [DOL MSPA](https://www.dol.gov/agencies/whd/agriculture/mspa), [CDC U.S.-Mexico Health](https://www.cdc.gov/us-mexico-health/), [Medicaid territories](https://www.medicaid.gov/medicaid/financial-management/medicaid-and-chip-programs-us-territories/index.html), [HHS Section 1557](https://www.hhs.gov/civil-rights/for-individuals/section-1557/index.html), [CDC LGBT Health](https://www.cdc.gov/lgbthealth/), [SAMHSA LGBTQI+](https://www.samhsa.gov/behavioral-health-equity/lgbtqi) |
| 围产期连续性 | CDC Maternal and Infant Health；HRSA Maternal Health；ACOG Optimizing Postpartum Care；CDC Breastfeeding；WomensHealth.gov breastfeeding at work；DOL PUMP at Work；CDC Preterm Birth；March of Dimes NICU；CDC stillbirth；SAMHSA / HRSA National Maternal Mental Health Hotline | 把怀孕到新生儿家庭转接拆成产前接入、产后随访、哺乳支持、NICU 出院、妊娠丧失和围产心理健康这些高敏感断点 | `domains/prenatal-care-access-risk-screening-continuity/`、`domains/postpartum-care-recovery-follow-up-continuity/`、`domains/lactation-breastfeeding-support-continuity/`、`domains/preterm-birth-nicu-discharge-transition-continuity/`、`domains/pregnancy-loss-stillbirth-bereavement-continuity/`、`domains/perinatal-mental-health-screening-referral-continuity/` | [CDC maternal-infant](https://www.cdc.gov/maternal-infant-health/), [HRSA maternal health](https://mchb.hrsa.gov/programs-impact/focus-areas/maternal-health), [ACOG postpartum care](https://www.acog.org/clinical/clinical-guidance/committee-opinion/articles/2018/05/optimizing-postpartum-care), [CDC breastfeeding](https://www.cdc.gov/breastfeeding/), [DOL PUMP](https://www.dol.gov/agencies/whd/pump-at-work), [CDC preterm birth](https://www.cdc.gov/reproductive-health/preterm-birth/), [March of Dimes NICU](https://www.marchofdimes.org/find-support/topics/neonatal-intensive-care-unit-nicu), [SAMHSA hotline](https://www.samhsa.gov/find-help/national-maternal-mental-health-hotline) |
| 儿科预防与早期筛查连续性 | CDC Newborn Screening；HRSA Newborn Screening；AAP Bright Futures；HRSA Bright Futures；CMS EPSDT；CDC child immunization schedules；CDC IIS；CDC Learn the Signs. Act Early.；CDC Lead Prevention；EPA Lead；HRSA CYSHCN | 把出生后早期可逆风险和预防入口拆成新生儿筛查结果随访、儿童健康体检、儿童免疫记录、发育行为筛查、儿童铅筛查和特殊健康需求儿童照护协调 | `domains/newborn-screening-result-followup-continuity/`、`domains/well-child-visit-preventive-care-continuity/`、`domains/childhood-immunization-schedule-record-continuity/`、`domains/developmental-behavioral-screening-referral-continuity/`、`domains/pediatric-lead-screening-environmental-followup-continuity/`、`domains/children-youth-special-health-care-needs-care-coordination-continuity/` | [CDC newborn screening](https://www.cdc.gov/newborn-screening/), [HRSA newborn screening](https://newbornscreening.hrsa.gov/), [AAP Bright Futures](https://www.aap.org/en/practice-management/bright-futures/), [CMS EPSDT](https://www.medicaid.gov/medicaid/benefits/early-and-periodic-screening-diagnostic-and-treatment/index.html), [CDC immunization schedules](https://www.cdc.gov/vaccines/hcp/imz-schedules/), [CDC Act Early](https://www.cdc.gov/ncbddd/actearly/), [CDC lead prevention](https://www.cdc.gov/lead-prevention/), [HRSA CYSHCN](https://mchb.hrsa.gov/programs-impact/focus-areas/children-youth-special-health-care-needs) |
| 青少年到成年转变连续性 | ACF Runaway and Homeless Youth；ACF Chafee Foster Care Independence；OJJDP reentry aftercare；Youth.gov juvenile justice reentry；SAMHSA Healthy Transitions；DOL YouthBuild；Job Corps；Youth.gov expectant and parenting young families；Child Welfare Information Gateway | 把“成年”拆成住所、安全、儿童福利出离、少年司法重返、儿童到成人心理健康系统转换、教育就业再进入和年轻父母支持这些跨制度断点 | `domains/runaway-homeless-youth-outreach-shelter-continuity/`、`domains/foster-care-aging-out-independent-living-continuity/`、`domains/juvenile-justice-reentry-aftercare-continuity/`、`domains/transition-age-youth-mental-health-service-continuity/`、`domains/opportunity-youth-education-employment-pathway-continuity/`、`domains/pregnant-parenting-youth-family-support-continuity/` | [ACF RHY](https://www.acf.hhs.gov/fysb/programs/runaway-homeless-youth), [ACF Chafee](https://acf.gov/cb/grant-funding/john-h-chafee-foster-care-independence-program), [OJJDP reentry aftercare](https://ojjdp.ojp.gov/statistical-briefing-book/reentry-aftercare), [Youth.gov reentry](https://youth.gov/youth-topics/juvenile-justice/reentry), [SAMHSA Healthy Transitions](https://www.samhsa.gov/grants/grant-announcements/sm-18-010), [DOL YouthBuild](https://www.dol.gov/agencies/eta/youth/youthbuild), [Job Corps](https://www.jobcorps.gov/), [Youth.gov parenting youth](https://youth.gov/youth-topics/expectant-parenting-young-families) |
| 生命事件、家庭关系与制度记录连续性 | USA.gov Vital Records / Name Change / Change Address；CDC/NCHS Vital Records；SSA；State Department Passport Name Change；USPS Change of Address；IRS Dependents；HealthCare.gov Household；ACF Child Support；Child Welfare Information Gateway | 把生命事件、姓名、地址、household、监护抚养和儿童安置拆成主体和家庭被制度持续识别、通知、授权、覆盖和保护的基础设施 | `domains/vital-records-life-event-continuity/`、`domains/name-change-identity-record-synchronization-continuity/`、`domains/address-residency-mail-service-continuity/`、`domains/household-composition-dependent-eligibility-continuity/`、`domains/family-law-custody-child-support-continuity/`、`domains/kinship-foster-adoption-care-continuity/` |
| 账户、债务、产权、移动证件与交易执行连续性 | FDIC Deposit Insurance；NCUA Share Insurance；CFPB bank accounts / debt collection / mortgage title；U.S. Courts Bankruptcy；USA.gov driver's licenses / vehicle registration / passports；State Department passports / authentications；DHS REAL ID；FTC subscriptions / negative option materials；state DMV / recorder / secretary of state materials | 把账户访问、债务义务、地契产权、驾驶与车辆登记、护照旅行证件、合同订阅账单和文件认证拆成主体资源控制、移动资格和文件承认的基础设施 | `domains/banking-deposit-account-access-continuity/`、`domains/debt-obligation-collection-relief-continuity/`、`domains/real-property-title-deed-record-continuity/`、`domains/driver-license-vehicle-registration-continuity/`、`domains/passport-travel-document-mobility-continuity/`、`domains/contract-subscription-billing-consent-continuity/`、`domains/notary-document-authentication-signature-continuity/` |
| 旅行、临时住宿与跨境移动执行连续性 | U.S. DOT Aviation Consumer Protection / Fly Rights / baggage / disability air travel；TSA Travel / TSA Cares；DHS REAL ID；State Department Travel Advisories / STEP / emergency assistance；CDC Travelers' Health / Yellow Book；CBP Travel / Know Before You Go / I-94；FTC travel scams；ADA.gov lodging；FEMA Transitional Sheltering Assistance | 把离家后的行程、航空中断、安检身份核验、行李物品、临时住宿、旅行警示领事协助、旅行健康准备和海关边境申报拆成可恢复的临时行动链 | `domains/long-distance-travel-booking-itinerary-continuity/`、`domains/air-passenger-rights-disruption-refund-continuity/`、`domains/aviation-security-screening-identity-continuity/`、`domains/baggage-personal-property-travel-continuity/`、`domains/lodging-temporary-accommodation-access-continuity/`、`domains/travel-advisory-consular-assistance-continuity/`、`domains/travel-health-preparedness-continuity/`、`domains/customs-border-entry-declaration-continuity/` |
| 消费者交易、履约、维修、支付争议、储值、价格费用与市场信任连续性 | FTC online shopping / Mail Order Rule / warranties / Nixing the Fix / junk fees / endorsements / consumer reviews；CFPB credit-card disputes / prepaid cards / junk fees；USA.gov consumer complaints；state consumer protection agencies | 把普通消费者购买拆成订单履约、失败交易恢复、产品维修、维修接入、支付纠错、储值余额、真实价格和可信评价这些资源转换基础设施 | `domains/online-retail-order-shipping-fulfillment-continuity/`、`domains/consumer-return-refund-dispute-resolution-continuity/`、`domains/consumer-warranty-service-contract-repair-continuity/`、`domains/right-to-repair-parts-manuals-access-continuity/`、`domains/payment-card-dispute-unauthorized-charge-continuity/`、`domains/gift-card-prepaid-stored-value-continuity/`、`domains/price-fee-disclosure-junk-fee-continuity/`、`domains/consumer-reviews-endorsements-marketplace-trust-continuity/` |
| 消费者信贷、贷款服务与跨期资源连续性 | CFPB credit cards / mortgages / auto loans / student loans / payday loans / remittance transfers / BNPL market materials；Federal Student Aid repayment；FTC car buying / payday loan consumer materials；state financial regulators | 把信用卡、消费贷款、房贷、车贷、学生贷款、发薪日小额贷款、BNPL 和汇款拆成主体如何用未来现金流、住房、车辆、教育资本和跨境资金支持当前行动的基础设施 | `domains/credit-card-revolving-credit-cost-continuity/`、`domains/consumer-loan-origination-apr-disclosure-continuity/`、`domains/mortgage-origination-servicing-foreclosure-continuity/`、`domains/auto-loan-lease-servicing-repossession-continuity/`、`domains/student-loan-servicing-repayment-forgiveness-continuity/`、`domains/payday-small-dollar-title-loan-continuity/`、`domains/buy-now-pay-later-installment-financing-continuity/`、`domains/remittance-money-transfer-disclosure-continuity/` |
| 个人保险、财产责任、灾害与理赔执行连续性 | NAIC consumer insurance / state insurance departments；FEMA FloodSmart / NFIP claims；Ready.gov flood and disaster materials；state residual-market / FAIR Plan materials；U.S. DOT / State Department / CDC travel context | 把汽车事故、家庭财产损失、洪水、巨灾、残障收入、长期照护、旅行中断和高额责任事件拆成 policy、coverage、deductible、claim、adjuster、proof of loss、appeal、complaint 和 defense 的风险转移执行层 | `domains/auto-insurance-liability-collision-claims-continuity/`、`domains/homeowners-renters-property-insurance-claims-continuity/`、`domains/flood-insurance-nfip-claims-continuity/`、`domains/catastrophe-wind-wildfire-earthquake-insurance-continuity/`、`domains/disability-income-insurance-claim-continuity/`、`domains/long-term-care-insurance-benefit-activation-continuity/`、`domains/travel-insurance-trip-protection-claims-continuity/`、`domains/personal-liability-umbrella-insurance-defense-continuity/` |
| 法律状态、保护身份、强制程序与记录救济连续性 | USCIS citizenship / green card / EAD / I-9 / asylum / refugees；State Department nationality；UNHCR statelessness / protection / refugee statistics；ICE detention management；BOP；BJS corrections；SAMHSA crisis services；HHS OCR；DOJ disability rights；U.S. Courts civil cases / FRCP；NCSC access to justice；NICCC；BJA National Reentry Resource Center | 把国籍、居留与工作授权、庇护难民保护、拘押状态、非自愿治疗权利、法院通知缺席判决和犯罪记录救济拆成主体法律状态、自由边界和长期尾部风险的基础设施 | `domains/citizenship-nationality-statelessness-continuity/`、`domains/immigration-status-residency-work-authorization-continuity/`、`domains/asylum-refugee-protection-status-continuity/`、`domains/detention-custody-confinement-status-continuity/`、`domains/civil-commitment-involuntary-treatment-rights-continuity/`、`domains/court-notice-service-process-default-judgment-continuity/`、`domains/criminal-record-relief-collateral-consequences-continuity/` |
| 学校服务、出勤、残障支持、营养、健康、通学、安全与心理支持连续性 | ED attendance / chronic absenteeism；NCES；McKinney-Vento / NCHE；IDEA / OSEP；OCR Section 504 and CRDC；USDA FNS school meals；CDC Healthy Schools；SAMHSA school mental health；FHWA Safe Routes to School；NHTSA school bus safety；StopBullying.gov；CDC youth violence prevention | 把学校作为儿童日常运行场所，拆成入学出勤、IEP/504、校餐营养、校医健康、通学安全、纪律排除、心理支持和安全气候这些学习轮次与儿童持续性基础设施 | `domains/school-enrollment-attendance-continuity/`、`domains/special-education-iep-504-accommodation-continuity/`、`domains/school-meals-nutrition-access-continuity/`、`domains/school-health-services-chronic-condition-continuity/`、`domains/school-transportation-safe-routes-continuity/`、`domains/school-discipline-exclusion-restraint-continuity/`、`domains/school-mental-health-counseling-support-continuity/`、`domains/school-climate-bullying-violence-prevention-continuity/` |
| 儿童营养项目执行连续性 | USDA FNS Child Nutrition Programs；Summer EBT / SUN Bucks；SFSP；CACFP；Afterschool Meals；Special Dietary Needs；Unpaid Meal Charges | 把儿童营养从学校日校餐拆到假期福利、暑期站点、照护场所餐食、课后餐食、特殊饮食安全和欠费污名这些跨日历、跨场所、跨支付执行链 | `domains/summer-ebt-sun-bucks-school-break-food-continuity/`、`domains/summer-food-service-program-site-access-continuity/`、`domains/cacfp-child-adult-care-food-program-continuity/`、`domains/afterschool-snack-supper-meal-continuity/`、`domains/special-diet-allergy-school-meal-accommodation-continuity/`、`domains/school-meal-debt-unpaid-balance-stigma-continuity/` |
| Food is Medicine、医疗营养支持与食物处方执行连续性 | HHS/ODPHP Food Is Medicine；HHS ASPE Food is Medicine current activities；NIH Common Fund Food is Medicine；CMS Medicaid HRSN；CMS Medicare Medical Nutrition Therapy；USDA ERS food security / food access；USDA SNAP-Ed | 把营养支持从“健康食物有益”拆成筛查转介、医学定制餐、医学定制食材、蔬果处方、临床 food pharmacy/pantry 和医学营养治疗这些医疗-食物-福利执行链 | `domains/nutrition-insecurity-screening-referral-continuity/`、`domains/medically-tailored-meals-chronic-care-continuity/`、`domains/medically-tailored-groceries-food-benefit-continuity/`、`domains/produce-prescription-fruit-vegetable-benefit-continuity/`、`domains/food-pharmacy-clinic-pantry-integration-continuity/`、`domains/medical-nutrition-therapy-dietitian-access-continuity/` | [HHS Food Is Medicine](https://odphp.health.gov/our-work/nutrition-physical-activity/food-medicine), [HHS ASPE](https://aspe.hhs.gov/reports/food-medicine-current-activities), [NIH Common Fund](https://commonfund.nih.gov/foodismedicine), [CMS HRSN](https://www.medicaid.gov/medicaid/section-1115-demonstrations/health-related-social-needs/index.html), [CMS MNT](https://www.cms.gov/medicare/coverage/national-coverage-determinations/ncd-mnt), [USDA ERS Food Security](https://www.ers.usda.gov/topics/food-nutrition-assistance/food-security-in-the-u-s/), [USDA SNAP-Ed](https://snaped.fns.usda.gov/) |
| 生殖内分泌、盆腔疼痛、出血贫血、不育与性功能连续性 | NICHD / MedlinePlus PCOS, endometriosis, uterine fibroids, vulvodynia；WHO infertility / endometriosis；NIDDK erectile dysfunction；CDC diabetes/PCOS and BV resources | 把常见生殖内分泌、盆腔疼痛、结构性出血、男性因素不育、血管性功能信号和外阴阴道疼痛从泛化生殖健康中拆成可审查机制层 | `domains/polycystic-ovary-syndrome-metabolic-reproductive-continuity/`、`domains/endometriosis-pelvic-pain-fertility-continuity/`、`domains/uterine-fibroids-bleeding-anemia-fertility-continuity/`、`domains/male-factor-infertility-sperm-health-continuity/`、`domains/erectile-dysfunction-vascular-sexual-function-continuity/`、`domains/vulvovaginal-pain-infection-sexual-function-continuity/` | [MedlinePlus PCOS](https://medlineplus.gov/polycysticovarysyndrome.html), [MedlinePlus endometriosis](https://medlineplus.gov/endometriosis.html), [MedlinePlus fibroids](https://medlineplus.gov/uterinefibroids.html), [WHO infertility](https://www.who.int/news-room/fact-sheets/detail/infertility), [NIDDK ED](https://www.niddk.nih.gov/health-information/urologic-diseases/erectile-dysfunction), [MedlinePlus vulvar disorders](https://medlineplus.gov/vulvardisorders.html) |
| 激素反馈轴与内分泌连续性 | NIDDK adrenal insufficiency / Cushing's syndrome / acromegaly；MedlinePlus pituitary disorders / hypogonadism / testosterone / POI；NICHD POI | 把内分泌总域进一步拆成皮质醇不足、皮质醇过量、垂体调度、GH/IGF-1、性腺轴和 POI 这些压力响应、代谢骨骼、视觉接口、生育未来和长期监测失效模式 | `domains/adrenal-insufficiency-cortisol-stress-response-continuity/`、`domains/cushing-syndrome-hypercortisolism-metabolic-bone-continuity/`、`domains/pituitary-disorders-hormone-axis-continuity/`、`domains/acromegaly-growth-hormone-cardiometabolic-continuity/`、`domains/hypogonadism-testosterone-sex-hormone-continuity/`、`domains/primary-ovarian-insufficiency-hormone-fertility-continuity/` | [NIDDK adrenal insufficiency](https://www.niddk.nih.gov/health-information/endocrine-diseases/adrenal-insufficiency-addisons-disease), [NIDDK Cushing's syndrome](https://www.niddk.nih.gov/health-information/endocrine-diseases/cushings-syndrome), [NIDDK acromegaly](https://www.niddk.nih.gov/health-information/endocrine-diseases/acromegaly), [MedlinePlus pituitary disorders](https://medlineplus.gov/pituitarydisorders.html), [MedlinePlus hypogonadism](https://medlineplus.gov/ency/article/001195.htm), [MedlinePlus POI](https://medlineplus.gov/primaryovarianinsufficiency.html) |
| 生殖技术、生育保存与第三方生殖治理连续性 | CDC ART / NASS / clinic success rates；FDA HCT/P reproductive tissue donor eligibility；ASRM fertility preservation / PGT / gestational carrier / donation / cross-border reproductive care；ACOG preimplantation genetic testing | 把生殖未来选择权从上位生殖健康拆到 ART/IVF 周期、质量报告、生育保存冷冻、供体筛查追溯、PGT 胚胎选择治理和第三方生殖法律伦理这些高风险执行接口 | `domains/assisted-reproductive-technology-ivf-cycle-continuity/`、`domains/art-clinic-success-rate-quality-reporting-continuity/`、`domains/fertility-preservation-gamete-embryo-cryostorage-continuity/`、`domains/reproductive-tissue-donor-screening-traceability-continuity/`、`domains/preimplantation-genetic-testing-embryo-selection-governance-continuity/`、`domains/third-party-reproduction-surrogacy-donor-legal-ethics-continuity/` | [CDC ART](https://www.cdc.gov/art/about/index.html), [CDC ART Success Rates](https://www.cdc.gov/art/success-rates/index.html), [CDC NASS](https://www.cdc.gov/art/php/nass/index.html), [FDA reproductive tissue donation](https://www.fda.gov/vaccines-blood-biologics/safety-availability-biologics/what-you-should-know-reproductive-tissue-donation), [ASRM fertility preservation](https://www.asrm.org/practice-guidance/practice-committee-documents/fertility-preservation-in-patients-with-medical-indications-a-committee-opinion-2026/), [ASRM PGT-A](https://www.asrm.org/practice-guidance/practice-committee-documents/the-use-of-preimplantation-genetic-testing-for-aneuploidy-a-committee-opinion-2024/), [ASRM gestational carriers](https://www.asrm.org/practice-guidance/practice-committee-documents/recommendations-for-practices-using-gestational-carriers-a-committee-opinion-2022/), [ACOG PGT](https://www.acog.org/clinical/clinical-guidance/committee-opinion/articles/2020/03/preimplantation-genetic-testing) |
| 高等教育学生生命周期、资助、校园支持、安全与国际学生身份连续性 | Federal Student Aid / FSA Partner Connect；NCES IPEDS；College Scorecard；ED OCR Section 504 / Title IX；ED Campus Safety and Clery；ADA.gov；SAMHSA / CDC campus mental health；ICE SEVIS；Study in the States；USCIS / State Department | 把高校拆成入学衔接、资助现金流、学位进度、基本需求、残障便利、心理危机、校园安全民权程序和国际学生身份报告这些能力资本形成基础设施 | `domains/postsecondary-admissions-transfer-articulation-continuity/`、`domains/student-financial-aid-grant-scholarship-continuity/`、`domains/academic-advising-degree-progress-continuity/`、`domains/campus-basic-needs-student-support-continuity/`、`domains/campus-disability-accommodations-accessibility-continuity/`、`domains/campus-mental-health-crisis-student-support-continuity/`、`domains/campus-safety-title-ix-clery-continuity/`、`domains/international-student-sevis-status-continuity/` |
| 数字账户、通信可达、数据可携带、Web 存在与平台准入连续性 | NIST Digital Identity；CISA Secure Our World / StopRansomware；FTC hacked account / identity theft；FCC SIM swap / port-out / number portability；FIDO Alliance passkeys；Data Transfer Initiative；ICANN / IANA / CISA DNS；EU DSA；OECD platform governance | 把邮箱、手机号、强认证、密码库、云备份、联系人图谱、域名/DNS 和平台账号拆成主体能否继续登录、接收通知、恢复资料、维持关系和迁移退出的数字接入基础设施 | `domains/email-account-recovery-continuity/`、`domains/phone-number-sim-portability-account-security-continuity/`、`domains/mfa-passkey-credential-recovery-continuity/`、`domains/password-manager-secret-vault-continuity/`、`domains/cloud-backup-file-sync-data-portability-continuity/`、`domains/messaging-contact-graph-portability-continuity/`、`domains/domain-dns-web-presence-continuity/`、`domains/platform-account-suspension-appeals-continuity/` |
| 软件、设备、开源、证书、云退出与 API 运行时连续性 | NIST SSDF；CISA Secure by Design / KEV / Open Source Roadmap；OpenSSF SLSA / Scorecard / Alpha-Omega；FTC Right to Repair；FCC Cyber Trust Mark；NIST IoT baseline；CA/Browser Forum；NIST key management；EU Data Act；Data Transfer Initiative | 把个人设备、家庭网络、软件供应链、补丁、开源维护、PKI 证书、云退出和 API 平台依赖拆成主体数字行动底座的可修、可信、可迁移和可降级条件 | `domains/personal-computing-device-lifecycle-repair-continuity/`、`domains/home-network-router-iot-security-continuity/`、`domains/software-supply-chain-dependency-provenance-continuity/`、`domains/software-update-vulnerability-patch-continuity/`、`domains/open-source-maintainer-sustainability-continuity/`、`domains/pki-certificate-cryptographic-trust-continuity/`、`domains/cloud-service-exit-interoperability-continuity/`、`domains/api-platform-dependency-runtime-continuity/` |
| 个人操作系统、日程、通知、文件流、检索与协作连续性 | IETF iCalendar / CalDAV；IANA Time Zone Database；Unicode CLDR；W3C Notifications / Push / Permissions / WebRTC / WAI；IETF WebRTC；PDF/A；NARA records；FADGI；Sitemaps；Schema.org；W3C Data on the Web；OpenAPI；OAuth；ODF；WebDAV | 把日历排程、通知警报、提醒例程、远程会议、文件捕获、搜索检索、个人自动化和协作文档拆成主体把时间、资料、权限、行动项和重复任务转化为连续行动的个人操作层 | `domains/calendar-scheduling-appointment-continuity/`、`domains/notification-alert-routing-attention-continuity/`、`domains/reminder-alarm-routine-task-continuity/`、`domains/meeting-video-conferencing-remote-collaboration-continuity/`、`domains/document-capture-ocr-pdf-record-workflow-continuity/`、`domains/search-index-discovery-retrieval-continuity/`、`domains/personal-automation-integration-workflow-continuity/`、`domains/collaborative-document-permission-version-continuity/` |
| 家庭物理操作、住所进入、食品保存、厨房、卫生、投递与维修连续性 | NFPA escape planning / cooking safety；CPSC recalls；DOE appliance standards；ENERGY STAR；USDA FSIS refrigeration / power outage；CDC food safety / cleaning / hygiene；EPA pesticide labels；Poison Help；USPS Manage Mail and Packages；UPU；FTC home improvement scams；FEMA individual assistance | 把住所进入、家用设备、家庭冷链、烹饪备餐、衣物卫生、清洁消毒、邮件包裹和维修服务拆成主体把住房、食物、卫生、资料和设备转化为连续行动的家庭物理操作层 | `domains/home-access-lock-key-entry-continuity/`、`domains/household-appliance-maintenance-repair-continuity/`、`domains/home-refrigeration-food-storage-continuity/`、`domains/cooking-meal-preparation-kitchen-safety-continuity/`、`domains/laundry-clothing-footwear-hygiene-continuity/`、`domains/household-cleaning-disinfection-pest-control-continuity/`、`domains/postal-parcel-delivery-pickup-continuity/`、`domains/household-maintenance-repair-contractor-continuity/` |
| 贴身设备、卫生耗材与适配用品连续性 | CDC Contact Lenses；NEI Contact Lenses；NIDCD / FDA Hearing Aids；Office on Women's Health Menstrual Cycle；CDC Hygiene；NIDDK Bladder Control / Diabetes Foot Problems；MedlinePlus Urinary Incontinence / Lymphedema；Medicare Therapeutic Shoes / Lymphedema Compression；NCI Lymphedema | 把视觉矫正、听觉辅助、月经用品、失禁吸收用品、糖尿病治疗鞋/卸载和压迫用品拆成主体感知、沟通、卫生、移动、尊严和公共参与的日常执行接口 | `domains/contact-lens-hygiene-eye-infection-continuity/`、`domains/hearing-aid-maintenance-battery-access-continuity/`、`domains/menstrual-product-access-safety-continuity/`、`domains/incontinence-absorbent-product-supply-dignity-continuity/`、`domains/diabetic-therapeutic-footwear-offloading-continuity/`、`domains/compression-garment-lymphedema-venous-continuity/` |
| 个人辅助设备运行连续性 | MedlinePlus Refractive Errors / Mobility Aids / Artificial Limbs；Medicare Wheelchairs and Scooters / Prosthetic Devices / CPAP Devices；CMS CPAP Devices and Accessories；CDC Older Adult Falls；FDA Fall Prevention Alarm classification | 把眼镜、轮椅/代步车、助行器具、假肢矫形、PAP 设备和跌倒检测响应设备拆成视觉、移动、身体-工具耦合、夜间恢复和求助链的日常运行接口 | `domains/eyeglasses-prescription-repair-replacement-continuity/`、`domains/wheelchair-scooter-battery-repair-access-continuity/`、`domains/walker-cane-crutch-fit-maintenance-continuity/`、`domains/prosthetic-limb-orthotic-fit-repair-continuity/`、`domains/cpap-pap-device-mask-supply-power-continuity/`、`domains/fall-detection-emergency-response-device-continuity/` |
| 家庭水与污水执行连续性 | EPA Private Drinking Water Wells / Lead and Copper Rule / Septic Systems / Cross-Connection and Backflow；CDC Drinking Water Well Testing / Home Water Treatment；EPA Flood Cleanup for Indoor Air | 把私人井、家庭滤水、铅铜饮水、建筑回流、化粪池和地下室进水潮湿恢复拆成主体在家庭端维持饮水、烹饪、卫生、住房和恢复空间的最后一公里执行层 | `domains/private-well-water-testing-treatment-continuity/`、`domains/household-water-treatment-filter-maintenance-continuity/`、`domains/lead-service-line-lead-copper-drinking-water-continuity/`、`domains/premise-plumbing-backflow-cross-connection-continuity/`、`domains/septic-system-maintenance-sewage-backup-continuity/`、`domains/basement-flooding-sump-pump-moisture-recovery-continuity/` |
| 家庭能源与热安全执行连续性 | USFA Appliance and Electrical Fire Safety / Home Heating Fire Safety；DOE Energy Saver Air Conditioner Maintenance / Thermostats / Weatherize；PHMSA Pipeline Leak Recognition；CDC Heat and Health | 把住宅电气、供暖排气、制冷热泵、燃气/丙烷、温控器和围护结构拆成主体在家庭端维持照明、通信、睡眠、照护、烹饪、医疗设备、工作学习和恢复的热电燃气控制层 | `domains/residential-electrical-wiring-outlet-safety-continuity/`、`domains/home-heating-equipment-chimney-vent-maintenance-continuity/`、`domains/home-cooling-heat-pump-air-conditioning-maintenance-continuity/`、`domains/natural-gas-propane-leak-shutoff-continuity/`、`domains/thermostat-temperature-control-thermal-comfort-continuity/`、`domains/weatherization-insulation-air-sealing-thermal-envelope-continuity/` |
| 家庭废弃物与处置执行连续性 | EPA Recycling Basics / Household Hazardous Waste / Used Household Batteries / Used Lithium-Ion Batteries / Composting at Home / Illegal Dumping；FDA Sharps Disposal Containers | 把住宅固废、家庭危险废物、居家锐器、电子废弃物电池、厨余堆肥和非法倾倒拆成主体在家庭和邻里端维持卫生、安全、隐私、火灾控制、害虫控制和公共行动半径的残余物治理层 | `domains/residential-solid-waste-collection-bin-sanitation-continuity/`、`domains/household-hazardous-waste-chemical-disposal-continuity/`、`domains/home-sharps-medical-waste-disposal-continuity/`、`domains/e-waste-battery-recycling-disposal-continuity/`、`domains/food-scrap-composting-pest-odor-continuity/`、`domains/illegal-dumping-litter-neighborhood-sanitation-continuity/` |
| 家庭室内空气与通风执行连续性 | EPA Air Cleaners and Air Filters / Indoor Particulate Matter / Combustion Pollutants / VOCs / Mold / Asthma Triggers；DOE Air Conditioner Maintenance；CDC Mold / Asthma | 把 HVAC 滤网、便携房间过滤、烹饪排风、湿度水分控制、灰尘过敏原源控制和 VOC/香氛/产品释放拆成主体在家庭端维持睡眠、呼吸、注意力、照护和恢复空间的空气执行层 | `domains/home-hvac-filter-maintenance-indoor-air-continuity/`、`domains/portable-air-cleaner-room-filtration-continuity/`、`domains/cooking-ventilation-range-hood-indoor-air-continuity/`、`domains/home-humidity-dehumidifier-moisture-control-continuity/`、`domains/household-dust-allergen-source-control-continuity/`、`domains/household-voc-fragrance-product-emission-continuity/` |
| 家庭物理秩序、物品访问与执行摩擦连续性 | CDC STEADI / NIA Falls / USFA Appliance and Electrical Fire Safety / CPSC Anchor It / CPSC Toys / CPSC Magnets / OSHA Computer Workstations / NIOSH Ergonomics | 把通道杂物、家庭线缆、储物稳定、高处够取、居家工位和儿童玩具小零件拆成主体在家庭端维持行动半径、有效时间、注意力、照护、儿童游戏和长期任务能力的物理摩擦层 | `domains/home-clutter-pathway-trip-fall-continuity/`、`domains/household-cord-cable-trip-entanglement-continuity/`、`domains/home-shelving-cabinet-storage-stability-continuity/`、`domains/household-ladder-step-stool-reach-task-continuity/`、`domains/home-office-workstation-ergonomics-continuity/`、`domains/toy-small-parts-choking-ingestion-continuity/` |
| 家庭运行元数据、位置标识、设备身份、服务入口与代理交接连续性 | Ready.gov Make a Plan / Document and Insure Your Property / Power Outages；USFA Appliance and Electrical Fire Safety；CPSC Recalls / SaferProducts.gov；FTC Warranties and Home Improvement Scams；EPA Septic and Flood Cleanup；Poison Help；FEMA Emergency Financial First Aid Kit | 把关键服务位置、断路器标签、水路阀门标签、设备型号序列召回、服务联系人目录和家庭运行地图拆成家庭系统可读性层，防止隐性知识只存在于单人记忆中 | `domains/home-utility-shutoff-location-labeling-continuity/`、`domains/household-circuit-breaker-panel-labeling-continuity/`、`domains/home-water-valve-plumbing-labeling-continuity/`、`domains/household-equipment-serial-model-recall-record-continuity/`、`domains/home-service-provider-emergency-contact-directory-continuity/`、`domains/household-operating-map-handoff-continuity/` |
| 个人移动执行、车辆、补能、停车、主动出行、辅助交通、按需交通、移动支付与实时导向连续性 | NHTSA recalls / vehicle safety；DOE AFDC / Energy.gov EV；FHWA bicycle/pedestrian / curb / tolling；FTA ADA paratransit / Mobility on Demand / fare collection；Medicaid.gov NEMT；GTFS / GTFS Realtime；ADA.gov transportation；CFPB / FDIC；FTC consumer guidance | 把个人车辆维护、燃料/EV 充电补能、停车路缘拖车扣押、步行骑行微移动、paratransit/NEMT、出租车网约车需求响应交通、票卡过路费账户和实时导向拆成主体把交通服务转化为真实到达的移动执行层 | `domains/personal-vehicle-maintenance-recall-repair-continuity/`、`domains/fuel-ev-charging-refueling-access-continuity/`、`domains/parking-curb-access-towing-impound-continuity/`、`domains/walking-bicycling-micromobility-continuity/`、`domains/paratransit-nemt-access-continuity/`、`domains/taxi-rideshare-demand-response-mobility-continuity/`、`domains/transit-fare-payment-toll-account-continuity/`、`domains/multimodal-trip-planning-real-time-wayfinding-continuity/` |
| 公共空间生存接入、如厕、饮水、休息降温、韧性中心、社区锚点、绿地、连接与无障碍服务连续性 | CDC WASH / handwashing；EPA / CDC drinking water；CDC heat health；EPA heat islands / green infrastructure；FEMA Community Lifelines；Ready.gov shelter / power outages；CISA critical infrastructure；IMLS public libraries；FCC E-Rate / emergency communications；CDC parks and physical activity；ADA.gov Title II / Title III / service animals / effective communication | 把公共厕所、公共饮水、公共座椅遮阴休息降温、社区韧性/避难中心、公共图书馆社区锚点、公园绿地、公共 Wi-Fi/设备充电和公共场所无障碍服务拆成主体离家后可停留、可恢复、可通信、可补水、可如厕、可避难和可进入服务的公共空间接入层 | `domains/public-restroom-sanitation-hygiene-access-continuity/`、`domains/public-drinking-water-hydration-access-continuity/`、`domains/public-seating-shade-rest-cooling-access-continuity/`、`domains/community-resilience-hub-shelter-center-continuity/`、`domains/public-library-community-anchor-access-continuity/`、`domains/parks-recreation-green-space-access-continuity/`、`domains/public-wifi-device-charging-connectivity-continuity/`、`domains/public-accommodation-accessibility-service-continuity/` |
| 邻里公共空间维护、地方服务请求、路灯、人行道坡道、雪冰、街道树和雨水口局部内涝连续性 | Open311 GeoReport / NYC 311 Open Data / USA.gov Local Governments；FHWA Nighttime Visibility / Pedestrian and Bicyclist Safety；U.S. Access Board PROWAG / ADA.gov Title II；CDC Winter Weather / Heat Health；USFS Urban and Community Forestry；EPA Stormwater / Green Infrastructure；Ready.gov Floods | 把街区尺度问题从个人观察转译为可报告、可派单、可维护、可复盘的公共空间维护对象，防止最后一公里公共工程失败切断夜间出行、无障碍通行、冬季通行、热缓冲、排水和地方服务响应 | `domains/municipal-311-service-request-continuity/`、`domains/streetlight-outage-nighttime-visibility-continuity/`、`domains/sidewalk-curb-ramp-maintenance-access-continuity/`、`domains/snow-ice-sidewalk-winter-access-continuity/`、`domains/street-tree-branch-hazard-shade-maintenance-continuity/`、`domains/storm-drain-catch-basin-local-flooding-continuity/` |
| 食物获得执行、grocery、福利兑换、社区发放、灾害供餐、送餐服务、婴儿配方和熟食安全可达连续性 | USDA ERS Food Access / Food Environment Atlas；USDA FNS SNAP eligibility / work requirements / SNAP Retailer / Online Purchasing / WIC / WIC EBT / TEFAP / FDD / Disaster Assistance / D-SNAP；ACL Nutrition Services / Older Americans Act；FDA Infant Formula / Recalls / Food Code / Food Allergies；CDC Infant Nutrition / Food Safety | 把食物从“存在于供应系统”转译为“主体可获得资格、可购买、可兑换、可领取、可配送、可安全食用、可在灾害和脆弱生命阶段不中断”的执行层，区分食品零售、SNAP 资格与兑换、WIC 兑换、社区食品发放、灾害供餐、老年送餐/集体餐、婴儿配方和外部熟食服务 | `domains/grocery-retail-food-store-access-continuity/`、`domains/snap-ebt-redemption-retailer-payment-continuity/`、`domains/snap-eligibility-recertification-abawd-continuity/`、`domains/wic-benefit-redemption-infant-maternal-nutrition-continuity/`、`domains/food-bank-pantry-community-food-distribution-continuity/`、`domains/emergency-food-disaster-feeding-continuity/`、`domains/home-delivered-meals-congregate-nutrition-services-continuity/`、`domains/infant-formula-baby-food-supply-safety-continuity/`、`domains/prepared-food-restaurant-cafeteria-safety-access-continuity/` |
| 治疗获得执行、药房配药、药品福利、用药核对、患者标签咨询、未用药回收、DME、居家氧疗和糖尿病耗材连续性 | FDA Drug Shortages / Medication Guides / Patient Medication Information / unused medicine disposal；CMS/Medicare Part D and DME；AHRQ Medication Reconciliation；DEA Take Back；CDC medication safety / diabetes | 把治疗从“医生开出方案”转译为“主体可取到、可支付、可理解、可持续执行、可补给、可维修、可安全处置”的执行层，区分药房配药、药品福利授权、药历一致性、标签咨询、未用药处置、DME、氧疗设备和糖尿病耗材 | `domains/retail-pharmacy-prescription-dispensing-continuity/`、`domains/pharmacy-benefit-formulary-prior-authorization-continuity/`、`domains/medication-reconciliation-regimen-adherence-continuity/`、`domains/patient-medication-labeling-counseling-continuity/`、`domains/unused-medicine-takeback-disposal-continuity/`、`domains/durable-medical-equipment-supplier-repair-continuity/`、`domains/home-oxygen-respiratory-equipment-supply-continuity/`、`domains/diabetes-insulin-glucose-monitoring-supplies-continuity/` |
| 门诊访问执行、provider 名录、初级照护、专科转诊、预约等待、门诊检验、诊断影像、门诊操作和 urgent care 分诊连续性 | CMS Network Adequacy / Care Compare；HRSA Health Center Program；AHRQ Care Coordination / Diagnostic Safety；Medicare coverage；CMS ASC Quality Reporting | 把医疗服务从“系统里有机构和项目”转译为“主体能找到入口、进入 panel、完成预约、穿过 referral、拿到检验/影像/操作结果并在非工作时间被接住”的执行层 | `domains/provider-directory-network-adequacy-continuity/`、`domains/primary-care-panel-appointment-access-continuity/`、`domains/specialist-referral-authorization-navigation-continuity/`、`domains/appointment-availability-wait-time-continuity/`、`domains/outpatient-laboratory-specimen-result-routing-continuity/`、`domains/diagnostic-imaging-order-scheduling-report-continuity/`、`domains/ambulatory-procedure-surgery-center-continuity/`、`domains/after-hours-urgent-care-triage-continuity/` |
| 医疗支付、理赔、账单与成本保护连续性 | HealthCare.gov enrollment / renewal / appeals；CMS Medicaid/CHIP eligibility and renewals；Medicare.gov enrollment / coverage options；CAQH CORE eligibility；CMS prior authorization / interoperability；CMS claims / appeals / Medical Bill Rights；CMS No Surprises；CMS Hospital Price Transparency；IRS 501(r)；CFPB medical debt | 把医疗支付从“有保险/有服务”转译为“主体持续参保、Medicaid/CHIP 续期不中断、Medicare 覆盖转接可理解、权益可核验、授权可追踪、claim/EOB 可解释、账单可缓冲、成本可预期、意外账单受保护、高额医疗债务有援助边界”的执行层 | `domains/health-insurance-enrollment-renewal-continuity/`、`domains/medicaid-chip-renewal-redetermination-continuity/`、`domains/medicare-enrollment-coverage-transition-continuity/`、`domains/insurance-eligibility-benefits-verification-continuity/`、`domains/medical-service-prior-authorization-utilization-management-continuity/`、`domains/claims-adjudication-eob-denial-continuity/`、`domains/patient-billing-payment-plan-continuity/`、`domains/price-transparency-good-faith-estimate-continuity/`、`domains/surprise-billing-balance-bill-protection-continuity/`、`domains/charity-care-financial-assistance-medical-debt-continuity/` |
| 患者权利、记录访问、临床沟通与医疗民权连续性 | HHS HIPAA access/amendment；ONC patient records / information blocking / USCDI / FHIR；AHRQ diagnostic safety / CANDOR / SHARE；HHS CLAS / LEP.gov；ADA.gov effective communication / healthcare accessibility；CMS complaints / state survey agency / ombuds；HHS OCR Section 1557 | 把医疗遭遇从“服务发生/账单处理”转译为“主体能看见医疗任务、获得和修正记录、接收结果、理解风险、表达同意或拒绝、获得语言和残障便利、投诉纠错并免受歧视”的患者权利执行层 | `domains/patient-portal-account-message-continuity/`、`domains/medical-record-access-amendment-release-continuity/`、`domains/clinical-results-notification-followup-continuity/`、`domains/informed-consent-refusal-shared-decision-continuity/`、`domains/healthcare-language-interpreter-effective-communication-continuity/`、`domains/healthcare-disability-accommodation-accessibility-continuity/`、`domains/patient-grievance-complaint-ombuds-continuity/`、`domains/healthcare-civil-rights-nondiscrimination-continuity/` |
| 急救健康信息与紧急交接连续性 | MedlinePlus Personal Health Records；Ready.gov Make a Plan / Disability；CDC vaccination records / IIS；OrganDonor.gov / HRSA organ donation；FDA UDI / AccessGUDID | 把急救、灾害、失能和死亡边界从“主体能否自己表达”转译为“系统是否能读取最小关键资料、联系支持网络、看见关键警报、转交药物设备状态、识别慢病计划、验证免疫记录、执行捐赠意愿和识别功能需求”的紧急交接执行层 | `domains/emergency-contact-next-of-kin-notification-continuity/`、`domains/personal-health-record-emergency-summary-continuity/`、`domains/medical-id-allergy-critical-alert-continuity/`、`domains/medication-list-implant-device-emergency-continuity/`、`domains/chronic-condition-emergency-action-plan-continuity/`、`domains/immunization-record-proof-continuity/`、`domains/organ-donor-registry-anatomical-gift-continuity/`、`domains/access-functional-needs-emergency-registry-continuity/` |
| 死亡后、遗属恢复、福利理赔、遗产交接与账户收束连续性 | CDC/NCHS NVSS；USA.gov death of a loved one；FTC Funeral Rule；SSA survivor benefits；NAIC Life Insurance Policy Locator；FTC identity theft / subscription cancellation | 把死亡边界从“主体终止”继续追问到“死亡事实能否证明、遗体能否处置、纪念和遗体位置能否保留、幸存者能否恢复、遗属福利和寿险能否兑现、资产负债能否盘点、账户订阅能否关闭”的死亡后执行层 | `domains/death-certificate-registration-cause-of-death-record-continuity/`、`domains/funeral-cremation-burial-disposition-continuity/`、`domains/cemetery-memorial-remains-location-continuity/`、`domains/bereavement-leave-grief-support-continuity/`、`domains/survivor-benefits-death-notification-continuity/`、`domains/life-insurance-beneficiary-claim-continuity/`、`domains/estate-inventory-asset-liability-handoff-continuity/`、`domains/post-death-account-closure-service-cancellation-continuity/` |
