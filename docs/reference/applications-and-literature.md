...
| 家庭暴力、性暴力与受害者支持 | CDC IPV / NISVS；DOJ OVW；ACF OFVPS；HHS OWH Get Help；OVC Help for Victims；VictimConnect | 把亲密伴侣暴力、性暴力、跟踪、犯罪伤害、求助入口、服务导航、保护和赔偿纳入 Human Infra，而不是默认家庭和关系总是安全背景 | 亲密伴侣暴力、性暴力、受害者服务、保护令、庇护、赔偿、创伤支持、反受害者归因 |
...
- CDC IPV / NISVS、DOJ OVW、ACF OFVPS、OVC Help for Victims、HHS OWH Get Help 和 VictimConnect 是亲密伴侣暴力、性暴力、跟踪、犯罪受害者服务和求助入口资料，不是个人安全计划、实时危险评估、法律意见、庇护床位保证、赔偿承诺、执法承诺或公开暴露受害者身份的许可。
...
- 家庭暴力与受害者支持模板：暴力类型、受害者关系、安全联系偏好、服务入口、热线/转介、庇护或临时住房、医疗与创伤支持、保护令/法律援助、赔偿、儿童和照护安排、数字安全、隐私和反受害者归因边界。
