...
| 生物医学平台、年龄指标与器官替换 | FDA gene/cell therapy / FDA genome editing guidance / NIA aging biology / HuBMAP / Bridge2AI / NCI CAR-T / ISSCR / NCATS Tissue Chip / FDA Xenotransplantation / OPTN | 有效永生的定量模型需要把遗传改写、衰老指标、多组学基线、工程细胞、人体相关模型和器官替换放进证据与安全边界，而不是只讲“抗衰”叙事 | 基因治疗与编辑递送安全、生物年龄钟验证、多组学个人基线、工程细胞疗法、类器官组织芯片、异种移植与工程器官替换 | [FDA cell and gene therapy](https://www.fda.gov/vaccines-blood-biologics/cellular-gene-therapy-products), [FDA genome editing guidance](https://www.fda.gov/regulatory-information/search-fda-guidance-documents/human-gene-therapy-products-incorporating-human-genome-editing), [NIA biology of aging](https://www.nia.nih.gov/research/dab/biology-aging), [HuBMAP](https://commonfund.nih.gov/hubmap), [Bridge2AI](https://commonfund.nih.gov/bridge2ai), [NCI CAR-T](https://www.cancer.gov/about-cancer/treatment/research/car-t-cells), [ISSCR Guidelines](https://www.isscr.org/guidelines), [NCATS Tissue Chip](https://ncats.nih.gov/research/research-activities/tissue-chip), [FDA xenotransplantation](https://www.fda.gov/vaccines-blood-biologics/xenotransplantation), [OPTN data](https://optn.transplant.hrsa.gov/data/) |
...
| 生物医学平台、年龄指标与器官替换 | FDA gene/cell therapy；FDA genome editing guidance；NIA aging biology；Horvath clock；GrimAge；DunedinPACE；HuBMAP；Bridge2AI；NCI CAR-T；ISSCR；NCATS Tissue Chip；FDA Xenotransplantation；OPTN | 把遗传递送安全、生物年龄验证、多组学基线、工程细胞、人体相关模型和器官替换纳入 Human Infra，而不是把它们混成“神奇延寿技术” | `domains/gene-therapy-genome-editing-delivery-safety/`、`domains/biological-age-clocks-biomarker-validation/`、`domains/multiomics-personal-baseline-systems-biology/`、`domains/engineered-cell-therapy-regenerative-platforms/`、`domains/organoids-organ-on-chip-disease-models/`、`domains/xenotransplantation-bioengineered-organ-replacement/` |
