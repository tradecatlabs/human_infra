...
| 医疗支付、理赔、账单与成本保护连续性 | HealthCare.gov enrollment and appeals / CMS Medicaid and CHIP eligibility / CAQH CORE eligibility / CMS prior authorization and interoperability / CMS Medical Bill Rights / CMS No Surprises / CMS Hospital Price Transparency / IRS 501(r) / CFPB medical debt | 医疗服务和保险覆盖存在不等于成本可承受；参保续保、权益核验、授权、理赔/EOB、账单、价格预估、意外账单保护和经济援助会决定治疗事件是否转化为恢复还是债务 | 参保续保、权益核验、医疗服务授权、claims/EOB/denial、患者账单/付款计划、价格透明/GFE、surprise billing protection、charity care/medical debt | [HealthCare.gov](https://www.healthcare.gov/), [CMS No Surprises](https://www.cms.gov/nosurprises), [CMS Hospital Price Transparency](https://www.cms.gov/priorities/key-initiatives/hospital-price-transparency) |
...
| 收入、税务、社保、退休、失业与工伤权益记录连续性 | DOL WHD；IRS Get Transcript；SSA Social Security Statement；DOL EBSA；PBGC；DOL unemployment insurance / ETA；DOL OWCP；OSHA recordkeeping | 把工资雇佣记录、税务记录、社会保险收入记录、退休账户、失业保险工资记录和工伤记录拆成主体过去劳动能否转化为未来权益的基础设施 | `domains/income-payroll-employment-record-continuity/`、`domains/tax-administration-filing-record-continuity/`、`domains/social-security-earnings-benefit-record-continuity/`、`domains/retirement-pension-savings-plan-continuity/`、`domains/unemployment-insurance-wage-record-continuity/`、`domains/workers-compensation-occupational-injury-benefit-continuity/` |
| 工作中断、照护事件与工作收入连续性 | DOL FMLA；DOL paid leave / sick leave；EEOC PWFA；DOL PUMP at Work；EEOC ADA reasonable accommodation；DOL ODEP / JAN；SSA Disability；ACL National Family Caregiver Support Program / Lifespan Respite | 把疾病、怀孕、育儿、残障、照护和复工事件拆成主体能否保留岗位、工资替代、合理便利、残障收入、照护支持和职业角色的基础设施 | `domains/family-medical-leave-job-protection-continuity/`、`domains/paid-sick-family-leave-wage-replacement-continuity/`、`domains/pregnancy-parental-work-continuity/`、`domains/workplace-accommodation-return-to-work-continuity/`、`domains/disability-income-work-capacity-benefit-continuity/`、`domains/family-caregiver-respite-work-continuity/` |
...
| 收入、税务、社保、退休、失业与工伤权益记录 | DOL WHD；IRS Get Transcript；SSA Social Security Statement；DOL EBSA；PBGC；DOL ETA unemployment insurance；DOL OWCP；OSHA recordkeeping | 把工资、税务、社会保险、退休计划、失业保险和工伤记录视为把过去劳动、缴费和伤害事实转化为未来资源与保障的行政基础设施 | 工资记录、雇佣核验、税务 transcript、收入记录、养老金账户、UI wage records、工伤记录、纠错、申诉、反欺诈 |
| 工作中断、照护事件与工作收入连续性 | DOL FMLA；DOL paid leave / sick leave；EEOC PWFA；DOL PUMP at Work；EEOC ADA reasonable accommodation；DOL ODEP；SSA Disability；ACL caregiver support / respite | 把疾病、家庭照护、孕产育儿、残障、复工和照护者负担视为岗位、收入、保险和未来职业路径连续性事件，而不是私人家庭问题 | 岗位保护、工资替代、孕产育儿便利、泵奶支持、合理便利、复工、残障收入、照护者支持、respite、反报复 |
