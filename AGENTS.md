...
└── domains/               # 可独立演化的子域
    ...
    ├── unemployment-insurance-claim-appeal-identity-continuity/ # 失业保险申领、身份核验与申诉支付连续性
    ...
    ├── ssi-ssdi-disability-review-appeal-continuity/ # SSI/SSDI 残障复审、申诉与支付连续性
    ...
    ├── nutrition-insecurity-screening-referral-continuity/ # 营养不安全筛查与转介连续性
    ├── medically-tailored-meals-chronic-care-continuity/ # 医学定制餐与慢病照护连续性
    ├── medically-tailored-groceries-food-benefit-continuity/ # 医学定制食材与食物福利连续性
    ├── produce-prescription-fruit-vegetable-benefit-continuity/ # 蔬果处方与农产品福利连续性
    ├── food-pharmacy-clinic-pantry-integration-continuity/ # 食物药房、临床 pantry 与医疗整合连续性
    ├── medical-nutrition-therapy-dietitian-access-continuity/ # 医学营养治疗与营养师可达连续性
    ...
    ├── municipal-311-service-request-continuity/ # 市政 311 与非紧急服务请求连续性
    ├── streetlight-outage-nighttime-visibility-continuity/ # 路灯故障与夜间可见性连续性
    ├── sidewalk-curb-ramp-maintenance-access-continuity/ # 人行道、路缘坡道维护与可达连续性
    ├── snow-ice-sidewalk-winter-access-continuity/ # 雪冰、人行道与冬季通行连续性
    ├── street-tree-branch-hazard-shade-maintenance-continuity/ # 街道树、断枝风险与树荫维护连续性
    ├── storm-drain-catch-basin-local-flooding-continuity/ # 雨水口、catch basin 与局部内涝连续性
    ...
    ├── snap-eligibility-recertification-abawd-continuity/ # SNAP 资格、续期、ABAWD 与 E&T 连续性
    ...
    ├── medicaid-chip-renewal-redetermination-continuity/ # Medicaid/CHIP 续期与重新判定连续性
    ├── medicare-enrollment-coverage-transition-continuity/ # Medicare 参保与覆盖转换连续性
    ...
    ├── adrenal-insufficiency-cortisol-stress-response-continuity/ # 肾上腺不足与皮质醇应激响应连续性
    ├── cushing-syndrome-hypercortisolism-metabolic-bone-continuity/ # 库欣综合征与高皮质醇系统负荷连续性
    ├── pituitary-disorders-hormone-axis-continuity/ # 垂体疾病与多激素轴连续性
    ├── acromegaly-growth-hormone-cardiometabolic-continuity/ # 肢端肥大症与 GH/IGF-1 连续性
    ├── hypogonadism-testosterone-sex-hormone-continuity/ # 性腺功能低下与性激素连续性
    ├── primary-ovarian-insufficiency-hormone-fertility-continuity/ # POI、卵巢激素与生育连续性
    ...
    ├── prenatal-care-access-risk-screening-continuity/ # 产前照护接入与风险筛查连续性
    ├── postpartum-care-recovery-follow-up-continuity/ # 产后照护恢复与随访连续性
    ├── lactation-breastfeeding-support-continuity/ # 哺乳泵奶与喂养支持连续性
    ...
    ├── tanf-cash-assistance-work-support-continuity/ # TANF 现金援助与工作支持连续性
    ...
    ├── eyeglasses-prescription-repair-replacement-continuity/ # 眼镜处方、修理与替换连续性
    ├── wheelchair-scooter-battery-repair-access-continuity/ # 轮椅代步车电池与维修可得连续性
    ├── walker-cane-crutch-fit-maintenance-continuity/ # 助行器、手杖与拐杖适配维护连续性
...
- `domains/endocrine-hormonal-regulation/` 负责激素轴、反馈环、代谢信号、压力反应、生殖、骨骼和情绪调节；`domains/adrenal-insufficiency-cortisol-stress-response-continuity/`、`domains/cushing-syndrome-hypercortisolism-metabolic-bone-continuity/`、`domains/pituitary-disorders-hormone-axis-continuity/`、`domains/acromegaly-growth-hormone-cardiometabolic-continuity/`、`domains/hypogonadism-testosterone-sex-hormone-continuity/` 和 `domains/primary-ovarian-insufficiency-hormone-fertility-continuity/` 负责把肾上腺不足、库欣、垂体疾病、肢端肥大症、性腺功能低下和 POI 拆成压力响应、激素过量、多轴调度、GH/IGF-1、性激素和卵巢激素/生育接口这些可独立审查的内分泌反馈轴。
...
- `domains/tanf-cash-assistance-work-support-continuity/` 负责 TANF 现金援助、工作参与、时间限制、制裁、case management、托育/交通支持和家庭现金流恢复。
...
- `domains/nutrition-insecurity-screening-referral-continuity/`、`domains/medically-tailored-meals-chronic-care-continuity/`、`domains/medically-tailored-groceries-food-benefit-continuity/`、`domains/produce-prescription-fruit-vegetable-benefit-continuity/`、`domains/food-pharmacy-clinic-pantry-integration-continuity/` 和 `domains/medical-nutrition-therapy-dietitian-access-continuity/` 负责 Food is Medicine / 医疗营养支持执行连续性，覆盖营养不安全筛查转介、医学定制餐、医学定制食材、蔬果处方、临床 food pharmacy/pantry 和医学营养治疗营养师可达。
...
- `domains/municipal-311-service-request-continuity/`、`domains/streetlight-outage-nighttime-visibility-continuity/`、`domains/sidewalk-curb-ramp-maintenance-access-continuity/`、`domains/snow-ice-sidewalk-winter-access-continuity/`、`domains/street-tree-branch-hazard-shade-maintenance-continuity/` 和 `domains/storm-drain-catch-basin-local-flooding-continuity/` 负责邻里公共空间维护、地方服务请求与最后一公里公共工程执行连续性条件，覆盖 311 服务请求、路灯夜间可见性、人行道/路缘坡道、雪冰通行、街道树木和雨水口局部内涝。
...
- `domains/health-insurance-enrollment-renewal-continuity/`、`domains/medicaid-chip-renewal-redetermination-continuity/`、`domains/medicare-enrollment-coverage-transition-continuity/`、`domains/insurance-eligibility-benefits-verification-continuity/`、`domains/medical-service-prior-authorization-utilization-management-continuity/`、`domains/claims-adjudication-eob-denial-continuity/`、`domains/patient-billing-payment-plan-continuity/`、`domains/price-transparency-good-faith-estimate-continuity/`、`domains/surprise-billing-balance-bill-protection-continuity/` 和 `domains/charity-care-financial-assistance-medical-debt-continuity/` 负责健康保险参保续保、Medicaid/CHIP 续期重判、Medicare 覆盖转换、权益核验、医疗服务授权、理赔/EOB/拒付、患者账单/付款计划、价格透明/GFE、意外账单保护和 charity care/医疗债务这些医疗支付执行连续性条件。
...
- `domains/chronic-pain-functional-restoration-continuity/`、`domains/low-back-pain-spine-function-continuity/`、`domains/osteoarthritis-joint-function-continuity/`、`domains/autoimmune-rheumatic-disease-inflammatory-burden-continuity/`、`domains/inflammatory-bowel-disease-digestive-continuity/`、`domains/chronic-liver-disease-masld-mash-continuity/`、`domains/thyroid-disease-endocrine-function-continuity/`、`domains/adrenal-insufficiency-cortisol-stress-response-continuity/`、`domains/cushing-syndrome-hypercortisolism-metabolic-bone-continuity/`、`domains/pituitary-disorders-hormone-axis-continuity/`、`domains/acromegaly-growth-hormone-cardiometabolic-continuity/`、`domains/hypogonadism-testosterone-sex-hormone-continuity/`、`domains/primary-ovarian-insufficiency-hormone-fertility-continuity/`、`domains/iron-deficiency-anemia-oxygen-carrying-continuity/`、`domains/asthma-copd-maintenance-control-continuity/` 和 `domains/allergic-atopic-disease-immunologic-burden-continuity/` 负责慢性疼痛、腰背痛、骨关节炎、自身免疫风湿病、炎症性肠病、MASLD/MASH 慢性肝病、甲状腺疾病、皮质醇轴、垂体轴、GH/IGF-1、性激素轴、POI、铁缺乏贫血、哮喘/COPD 长期控制和过敏/特应性疾病这些慢性专科负担与功能恢复条件。
