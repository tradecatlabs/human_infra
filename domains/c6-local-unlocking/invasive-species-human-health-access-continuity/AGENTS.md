# Invasive Species Human Health Access Continuity 目录说明
...
本目录承载入侵物种如何通过健康暴露、生态服务和公共空间可达影响主体持续性的研究资料。
...
- `README.md`：定义入侵物种、生态服务、健康暴露和行动可达连续性的研究边界。
...
不提供物种鉴定、现场清除、农药/除草剂使用、捕捉处置、法规合规、生态补偿或执法判断。
