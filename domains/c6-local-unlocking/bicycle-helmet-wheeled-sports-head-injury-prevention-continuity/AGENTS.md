# bicycle-helmet-wheeled-sports-head-injury-prevention-continuity 目录说明
...
本目录承载自行车、轮式运动、头盔和头部伤害预防连续性研究域，关注微移动和休闲运动如何产生头部创伤风险。
...
- 只整理官方来源、头部伤害变量、环境接口和证据边界。
- 不提供头盔购买、佩戴调整、骑行教学、路线、法规、伤后处理或个体活动建议。
- 不收集儿童影像、路线、能力记录、事故材料、头盔照片或健康史。

## 上下游

- 上游：`walking-bicycling-micromobility-continuity/`、`road-traffic-injury-prevention-safe-mobility/`、`traumatic-brain-injury-neurotrauma-recovery/`。
- 下游：`physical-activity-mobility/`、`parks-recreation-green-space-access-continuity/`、`functioning-quality-of-life-outcomes/`。
