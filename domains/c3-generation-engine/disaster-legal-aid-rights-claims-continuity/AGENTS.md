...
- 本域只研究灾害法律援助作为恢复基础设施，不提供法律意见、理赔建议、诉讼策略或个案判断。
- 不保存任何案件事实、身份文件、合同、保险、家庭安全或律师通信资料。
- 文档必须持续提醒用户回到本地法律援助和持证专业人员。

## 上下游关系

- 上游：`domains/c4-conversion-channel/disaster-individual-assistance-benefits-navigation-continuity/`。
- 下游：`domains/c5-ecological-substrate/self-represented-litigant-court-self-help-continuity/`、`domains/c5-ecological-substrate/homeowners-renters-property-insurance-claims-continuity/`。
