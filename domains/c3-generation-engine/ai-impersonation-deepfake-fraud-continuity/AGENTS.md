# AI Impersonation Deepfake Fraud Continuity 架构说明
...
| 字段 | 内容 |
| --- | --- |
| 物理路径 | `domains/c3-generation-engine/ai-impersonation-deepfake-fraud-continuity` |
| 所属层级 | `C3` - 可能性生成引擎层 |
...
本目录承载 AI 冒充、deepfake fraud、voice cloning scam 和身份误导风险资料。它只整理公开警示和恢复边界，不提供制作、诈骗、社工、检测规避或反击方案。
...
- 新增资料必须回到 FTC、FBI、FCC、NIST、CISA 或其他官方/权威来源。
- 区分诈骗警示、冒充风险、内容真实性、账号安全和身份盗用恢复。
- 不收集真实诈骗样本、受害者资料、声音/面部素材、账号信息、金融信息或私人通信内容。
