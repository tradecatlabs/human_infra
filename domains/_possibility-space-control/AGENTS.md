...
- `classification.tsv` 负责把全部正式研究域映射到 C1-C6，并记录每个研究域的真实 `physical_path`；C0 作为价值核不分配普通研究域。
...
- 新增、删除、重命名或移动研究域时，必须同步更新对应 C1-C6 物理目录、`classification.tsv`、`summary.md` 和必要的根/域索引。
