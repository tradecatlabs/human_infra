...
- `source-papers/cortical-labs-research-papers/` 保存 Cortical Labs / DishBrain / SBI / OI 论文 PDF 包、manifest 和下载状态记录，用作本域 Source Card 与 Claim-Evidence Matrix 的原始阅读材料。
...
- 新增或替换 PDF 包时必须保留 manifest / status 文件；不得只保留 PDF 而丢失来源、下载状态和缺失项记录。
