# Third Party Reproduction Surrogacy Donor Legal Ethics Continuity 目录说明
...
| 字段 | 内容 |
| --- | --- |
| 物理路径 | `domains/c5-ecological-substrate/third-party-reproduction-surrogacy-donor-legal-ethics-continuity` |
| 所属层级 | `C5` - 可能性生态承载层 |
...
本目录承载第三方生殖、代孕、供体、预期父母、同意、法律伦理、跨境照护和后代权益资料。它处理多主体关系治理，不处理个案法律或医疗路径。
...
- 新增资料优先引用 ASRM gestational carrier、gamete/embryo donation、cross-border reproductive care 和公开法律伦理资料。
- 记录 parties、consent、screening、counseling、legal parentage、offspring information、compensation、insurance 和 exploitation boundary。
- 不写代孕安排建议、合同模板、诊所/律师推荐、规避法律、跨境撮合、供体识别或医疗选择建议。

## 上下游

- 上游：`assisted-reproductive-technology-ivf-cycle-continuity/`、`reproductive-tissue-donor-screening-traceability-continuity/`、`healthcare-civil-rights-nondiscrimination-continuity/`。
- 下游：`vital-records-life-event-continuity/`、`family-law-custody-child-support-continuity/`、`ethics-and-safety-boundaries.md`。
