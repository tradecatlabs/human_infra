...
| 字段 | 内容 |
| --- | --- |
| 物理路径 | `domains/c5-ecological-substrate/fair-housing-discrimination-reasonable-accommodation-continuity` |
| 所属层级 | `C5` - 可能性生态承载层 |
...
- 不提供个案法律意见、投诉策略、证据整理、便利申请代写或案件评估。
- 不输出歧视、筛选规避、报复、骚扰或服务动物欺诈方法。
- 必须区分公平住房原则、残障可达、地方保护类别和个案事实判断。
