# Harmful Algal Bloom Cyanotoxin Water Recreation Continuity 目录说明
...
- `README.md`：定义有害藻华、蓝藻毒素、水域关闭和主体行动连续性的研究边界。
...
不提供饮水判定、暴露诊断、水体采样、藻华识别、处理药剂、宠物急救或现场安全许可。
