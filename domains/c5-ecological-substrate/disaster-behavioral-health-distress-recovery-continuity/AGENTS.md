...
- 本域只研究灾害行为健康支持与恢复连续性，不提供诊断、治疗、危机干预或个案咨询。
- 不保存创伤经历、精神健康、未成年人、自伤、家庭暴力或热线记录。
- 涉及即时危险时，文档必须指向官方紧急服务和危机热线，而不是项目内部处理。

## 上下游关系

- 上游：`domains/c5-ecological-substrate/disaster-case-management-long-term-recovery-continuity/`。
- 下游：`domains/c6-local-unlocking/mental-health-affective-stability/`、`domains/c6-local-unlocking/sleep-circadian-recovery/`。
