...
- 上游：`governance-rights/`、`healthcare-access-continuity/`、`medicine-access-treatment-continuity/`、`legal-identity-civil-registration/`、`mental-health-affective-stability/`。
- 下游：`homelessness-unsheltered-health-continuity/`、`chronic-infectious-disease-care-continuity/`、`substance-exposure-control/`、`workforce-employment-services/`。
